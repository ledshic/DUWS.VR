...
blufor_SOLDIER_X =				"gm_ge_army_rifleman_g3a3_80_ols";				//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"gm_ge_army_antitank_g3a3_pzf84_80_ols";		//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"gm_ge_army_grenadier_g3a3_80_ols";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"gm_ge_army_squadleader_g3a3_p2a1_80_ols";		//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"gm_ge_army_radioman_g3a3_80_ols";				//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"gm_ge_army_machinegunner_mg3_80_ols";			//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"gm_ge_army_marksman_g3a3_80_ols";				//initHQ\fnc_HQguards
blufor_OFFICER_X =				"gm_ge_army_officer_p1_80_oli";					//initHQ\fnc_BluHQinit
...
blufor_BOAT_CREW_X =			"gm_ge_army_rifleman_g3a3_80_ols";				//supports\taxi\fnc_boatTaxi
...
blufor_SPECOPS_X =				"gm_ge_army_sf_rifleman_g3a4_80_wdl";				//operator
blufor_SPECOPS_GL_X =			"gm_ge_army_sf_grenadier_hk69a1_80_wdl";			//operator
blufor_SPECOPS_LAT_X =			"gm_ge_army_sf_antitank_mp5a2_pzf84_80_wdl";		//operator
blufor_SPECOPS_HAT_X =			"gm_ge_army_sf_antitank_mp5a2_pzf84_80_wdl";		//operator
blufor_SPECOPS_AA_X =			"gm_ge_army_sf_antiair_mp5a3_fim43_80_wdl";			//operator
blufor_SPECOPS_MG_X =			"gm_ge_army_machinegunner_mg3_80_ols";				//operator
blufor_SPECOPS_MEDIC_X =		"gm_ge_army_medic_g3a3_80_ols";						//operator
blufor_SPECOPS_MARK_X =			"gm_ge_army_sf_marksman_g3a3_80_wdl";				//operator
blufor_SPECOPS_SNIPER_X =		"gm_ge_army_sf_marksman_g3a3_80_wdl";				//operator
blufor_SPECOPS_EXP_X =			"gm_ge_army_sf_demolition_mp5a2_80_wdl";			//operator
blufor_SPECOPS_ENG_X = 			"gm_ge_army_engineer_g3a4_80_ols";					//operator
...
blufor_RQST_UNIT_01_X = 			["gm_ge_army_rifleman_g3a3_80_ols","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["gm_ge_army_grenadier_g3a3_80_ols","Grenadier (GraPi) (3CP)",3];
blufor_RQST_UNIT_03_X =				["gm_ge_army_machinegunner_mg3_80_ols","Machinegunner (MG3) (3CP)",3];
blufor_RQST_UNIT_04_X =				["gm_ge_army_demolition_g3a4_80_ols","Explosive Specialist (4CP)",4];
blufor_RQST_UNIT_05_X =				["gm_ge_army_medic_g3a3_80_ols","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["gm_ge_army_antitank_g3a3_pzf84_80_ols","AT Specialist (4CP)",4];
blufor_RQST_UNIT_07_X =				["gm_ge_army_antiair_g3a3_fim43_80_ols","AA Specialist (4CP)",4];
blufor_RQST_UNIT_08_X =				["gm_ge_army_engineer_g3a4_80_ols","Engineer (4CP)",4];
blufor_RQST_UNIT_09_X =				["gm_ge_army_marksman_g3a3_80_ols","Marksman (3CP)",3];
blufor_RQST_UNIT_10_X =				["gm_ge_army_crew_mp2a1_80_oli","Crewman (2CP)",4];
blufor_RQST_UNIT_11_X =				["gm_ge_army_antitank_g3a3_milan_80_ols","Rifleman (Milan) (4CP)",4];
...
blufor_RQST_VEHICLE_15_X =			["gm_ge_army_marder1a1plus","Marder 1A1 (30CP)",30];
blufor_RQST_VEHICLE_16_X =			["gm_ge_army_luchsa1","Luchs 2A1 (25CP)",25];
blufor_RQST_VEHICLE_17_X =			["gm_ge_army_Leopard1a1","Leopard 1A1 (35CP)",35];
