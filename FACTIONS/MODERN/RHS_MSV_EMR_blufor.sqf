...
blufor_SOLDIER_X =				"rhs_msv_emr_rifleman";				//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"rhs_msv_emr_LAT";					//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"rhs_msv_emr_grenadier";			//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"rhs_msv_emr_junior_sergeant";		//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"rhs_msv_emr_sergeant";				//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"rhs_msv_emr_arifleman";			//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"rhs_msv_emr_marksman";				//initHQ\fnc_HQguards
blufor_OFFICER_X =				"rhs_msv_emr_officer";				//initHQ\fnc_BluHQinit
...
blufor_CAR_PATROL1_X =			"rhs_tigr_sts_msv";				//random patrol
blufor_APC_PATROL1_X =			"rhs_btr70_msv";				//random patrol
...
blufor_SPECOPS_HAT_X =			"rhs_mvd_izlom_grenadier_rpg";		//operator
blufor_SPECOPS_AA_X =			"rhs_msv_emr_aa";					//operator
...
blufor_SPECOPS_ENG_X = 			"rhs_msv_emr_engineer";			//operator
...
blufor_RQST_UNIT_01_X = 			["rhs_msv_emr_rifleman","Rifleman (EMR) (2CP)",2];
blufor_RQST_UNIT_02_X =				["rhs_msv_emr_grenadier","Grenadier (EMR) (3CP)",3];
blufor_RQST_UNIT_03_X =				["rhs_msv_emr_arifleman","Automatic Rifleman (EMR) (3CP)",3];
blufor_RQST_UNIT_04_X =				["rhs_msv_emr_machinegunner","Heavy Gunner (EMR) (4CP)",4];
blufor_RQST_UNIT_05_X =				["rhs_msv_emr_medic","Medic (EMR) (4CP)",4];
blufor_RQST_UNIT_06_X =				["rhs_msv_emr_LAT","AT Rifleman (EMR) (3CP)",3];
blufor_RQST_UNIT_07_X =				["rhs_msv_emr_grenadier_rpg","AT Specialist (EMR) (4CP)",4];
blufor_RQST_UNIT_08_X =				["rhs_msv_emr_aa","AA Specialist (EMR) (4CP)",4];
blufor_RQST_UNIT_09_X =				["rhs_msv_emr_engineer","Engineer (EMR) (4CP)",4];
blufor_RQST_UNIT_10_X =				["rhs_msv_emr_marksman","Marksman (EMR) (3CP)",3];
...
blufor_RQST_VEHICLE_04_X =			["rhs_uaz_open_MSV_01","UAZ open (3CP)",3];
blufor_RQST_VEHICLE_05_X =			["rhs_tigr_m_msv","GAZ 233114 (15CP)",15];
blufor_RQST_VEHICLE_06_X =			["rhs_tigr_sts_msv","GAZ HMG/GMG (25CP)",25];
blufor_RQST_VEHICLE_07_X =			["rhs_gaz66o_msv","GAZ-67 Transport Uncovered (8CP)",8];
blufor_RQST_VEHICLE_08_X =			["rhs_kamaz5350_msv","KamAZ 5350 Transport Covered (8CP)",8];
blufor_RQST_VEHICLE_09_X =			["RHS_Ural_Repair_MSV_01","Ural Repair Trk (15CP)",15];
blufor_RQST_VEHICLE_10_X =			["rhs_gaz66_ammo_msv","GAZ-66 Ammo Trk (15CP)",15];
blufor_RQST_VEHICLE_11_X =			["RHS_Ural_Fuel_MSV_01","Ural Fuel Trk (15CP)",15];
blufor_RQST_VEHICLE_12_X =			["rhs_btr70_msv","BTR-70 (25CP)",25];
blufor_RQST_VEHICLE_13_X =			["rhs_btr80_msv","BTR-80 (30CP)",30];
blufor_RQST_VEHICLE_14_X =			["rhs_btr80a_msv","BTR-80A (35CP)",35];
blufor_RQST_VEHICLE_15_X =			["rhs_bmp1_msv","BMP-1 (28CP)",25];
blufor_RQST_VEHICLE_16_X =			["rhs_bmp2k_msv","BMP-2K (30CP)",30];
...
blufor_RQST_VEHICLE_22_X =			["RHS_BM21_MSV_01","BM-21 MSV Rocket (75CP)",75];
...
blufor_RQST_VEHICLE_26_X =			["RHS_Mi8mt_vvsc","MI-8 MT Armed (26CP)",26];
blufor_RQST_VEHICLE_27_X =			["RHS_Mi8AMTSh_vvsc","MI-8 AMT Armed (30CP)",30];
blufor_RQST_VEHICLE_28_X =			["rhs_mi28n_vvsc","MI-28N Armed (35CP)",35];
blufor_RQST_VEHICLE_29_X =			["RHS_Mi24V_vvsc","MI-24V Attack Heli (45CP)",45];
