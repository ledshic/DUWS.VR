...
blufor_SPECOPS_X =				"uns_men_VC_mainforce_67_Ra1";			//operator
blufor_SPECOPS_GL_X =			"uns_men_VC_mainforce_67_AS5";			//operator
blufor_SPECOPS_LAT_X =			"uns_men_VC_mainforce_67_AT2";			//operator
blufor_SPECOPS_HAT_X =			"uns_men_VC_mainforce_67_AT";			//operator
blufor_SPECOPS_AA_X =			"uns_men_VC_mainforce_67_RTO";			//operator
blufor_SPECOPS_MG_X =			"uns_men_VC_mainforce_67_Rmg";			//operator
blufor_SPECOPS_MEDIC_X =		"uns_men_VC_mainforce_67_MED";			//operator
blufor_SPECOPS_MARK_X =			"uns_men_VC_mainforce_67_MRK";			//operator
blufor_SPECOPS_SNIPER_X =		"uns_men_VC_mainforce_67_MRK";			//operator
blufor_SPECOPS_EXP_X =			"uns_men_VC_mainforce_67_SAP";			//operator
blufor_SPECOPS_ENG_X = 			"uns_men_VC_mainforce_67_SAP";			//operator
blufor_SPECOPS_SL_X = 			"uns_men_VC_mainforce_67_nco";			//operator Dang
blufor_SPECOPS_PL_X = 			"uns_men_VC_mainforce_67_off";			//operator Dang
blufor_SPECOPS_ASS_X = 			"uns_men_VC_mainforce_67_AS3";			//operator Dang
