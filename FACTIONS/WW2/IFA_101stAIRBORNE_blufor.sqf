...
blufor_SOLDIER_X =				"LIB_US_101AB_rifleman";			//patrol, fortify
blufor_SOLDIER_LAT_X =			"LIB_US_101AB_AT_soldier";			//initHQ\guards.sqf
blufor_SOLDIER_GL_X =			"LIB_US_101AB_grenadier";			//initHQ\guards.sqf 
blufor_SOLDIER_TL_X =			"LIB_US_101AB_corporal";			//initHQ\createpatrol.sqf
blufor_SOLDIER_SL_X =			"LIB_US_101AB_NCO";					//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"LIB_US_101AB_mgunner";				//initHQ\guards.sqf
blufor_MARKSMAN_X = 			"LIB_US_101AB_mgunner_assistant";	//initHQ\guards.sqf
blufor_OFFICER_X =				"LIB_US_101AB_CO";					//initHQ\BluHQinit.sqf
...
blufor_SPECOPS_X =				"LIB_US_101AB_rifleman";				//operator
blufor_SPECOPS_GL_X =			"LIB_US_101AB_grenadier";				//operator
blufor_SPECOPS_LAT_X =			"LIB_US_101AB_AT_soldier";				//operator
blufor_SPECOPS_HAT_X =			"LIB_US_101AB_AT_soldier";				//operator
blufor_SPECOPS_AA_X =			"LIB_US_101AB_radioman";				//operator
blufor_SPECOPS_MG_X =			"LIB_US_101AB_mgunner";					//operator
blufor_SPECOPS_AR_X =			"LIB_US_101AB_mgunner";					//operator Dang Edit
blufor_SPECOPS_MEDIC_X =		"LIB_US_101AB_medic";					//operator
blufor_SPECOPS_MARK_X =			"LIB_US_101AB_mgunner_assistant";		//operator
blufor_SPECOPS_SNIPER_X =		"LIB_US_101AB_mgunner_assistant";		//operator
blufor_SPECOPS_EXP_X =			"LIB_US_101AB_FC_rifleman";				//operator
blufor_SPECOPS_ENG_X = 			"LIB_US_101AB_FC_rifleman";				//operator
blufor_SPECOPS_SL_X = 			"LIB_US_101AB_NCO";						//operator Lt.Dang edit
blufor_SPECOPS_TL_X = 			"LIB_US_101AB_corporal";				//operator Lt.Dang edit
blufor_SPECOPS_ASS_X = 			"LIB_US_101AB_smgunner";				//operator Lt.Dang edit
...
blufor_RQST_UNIT_01_X = 			["LIB_US_101AB_rifleman","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["LIB_US_101AB_grenadier","Grenadier (3CP)",3];
blufor_RQST_UNIT_03_X =				["LIB_US_101AB_mgunner_assistant","MG Asst. (2CP)",2];
blufor_RQST_UNIT_04_X =				["LIB_US_101AB_mgunner","Heavy Gunner (4CP)",4];
blufor_RQST_UNIT_05_X =				["LIB_US_101AB_medic","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["LIB_US_101AB_AT_soldier","AT Rifleman (3CP)",3];
blufor_RQST_UNIT_07_X =				["LIB_US_101AB_radioman","Radioman (2CP)",2];
blufor_RQST_UNIT_08_X =				["LIB_US_101AB_NCO","NCO (2CP)",2];
blufor_RQST_UNIT_09_X =				["LIB_US_101AB_corporal","Corporal (4CP)",4];
