...
///////////////
///////////////   "UNSUNG_EV_VCG", "VC 445th Bn Local Force\4th Bn 12th Rgt. Regional Recon Force 1965","UNSUNG_LOCAL_VC"
///////////////
...
blufor_SOLDIER_X =				"uns_men_VC_local_RF2";				//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"uns_men_VC_mainforce_AT2";			//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_GL_X =			"uns_men_VC_local_RF7";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_TL_X =			"uns_men_VC_local_AS4";				//initHQ\createpatrol.sqf, initHQ\guards.sqf
blufor_SOLDIER_SL_X =			"uns_men_VC_local_nco";				//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"uns_men_VC_local_LMG";				//support\paradrop.sqf, initHQ\guards.sqf
blufor_MARKSMAN_X = 			"uns_men_VC_local_MRK2";			//initHQ\guards.sqf
blufor_OFFICER_X =				"uns_men_VC_mainforce_COM";			//initHQ\BluHQinit.sqf
...
blufor_BOAT_CREW_X =			"uns_men_VC_local_nco";				//support\taxi\boatTaxi.sqf
...
blufor_SPECOPS_X =				"uns_men_VC_recon_RF3";			//operator
blufor_SPECOPS_GL_X =			"uns_men_VC_recon_RF4";			//operator
blufor_SPECOPS_LAT_X =			"uns_men_VC_recon_AT";			//operator
blufor_SPECOPS_HAT_X =			"uns_men_VC_recon_AT";			//operator
blufor_SPECOPS_AA_X =			"uns_men_VC_recon_RTO";			//operator
blufor_SPECOPS_MG_X =			"uns_men_VC_recon_HMG";			//operator
blufor_SPECOPS_MEDIC_X =		"uns_men_VC_recon_MED";			//operator
blufor_SPECOPS_MARK_X =			"uns_men_VC_recon_MRK2";		//operator
blufor_SPECOPS_SNIPER_X =		"uns_men_VC_recon_MRK";			//operator
blufor_SPECOPS_EXP_X =			"uns_men_VC_recon_SAP";			//operator
blufor_SPECOPS_ENG_X = 			"uns_men_VC_recon_SAP2";		//operator
blufor_SPECOPS_SL_X = 			"uns_men_VC_recon_nco";			//operator Dang
blufor_SPECOPS_PL_X = 			"uns_men_VC_recon_off";			//operator Dang
blufor_SPECOPS_ASS_X = 			"uns_men_VC_recon_AS3";			//operator Dang
...
blufor_RQST_UNIT_01_X = 			["uns_men_VC_local_RF2","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["uns_men_VC_recon_RTO","Radio Operator (2CP)",2];
blufor_RQST_UNIT_03_X =				["uns_men_VC_local_LMG","Automatic Rifleman (3CP)",3];
blufor_RQST_UNIT_04_X =				["uns_men_VC_local_MED","Medic (4CP)",4];
blufor_RQST_UNIT_05_X =				["uns_men_VC_mainforce_AT2","L-AT Rifleman (3CP)",3];
blufor_RQST_UNIT_06_X =				["uns_men_VC_mainforce_AT","H-AT Rifleman (4CP)",4];
blufor_RQST_UNIT_07_X =				["uns_men_VC_local_SAP","Engineer (4CP)",4];
blufor_RQST_UNIT_08_X =				["uns_men_VC_local_MRK2","Marksman (3CP)",3];
