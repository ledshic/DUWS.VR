...
///////////////
///////////////   "LIB_FSJ_DAK", "IFA FALLSCHIRMJAGERS (Sicily)","IFA_FALLSCHIRMJAGERS_SICILY"
///////////////
...
blufor_SOLDIER_X =				"LIB_FSJ_soldier_dak";					//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"LIB_FSJ_AT_soldier_dak";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_GL_X =			"LIB_FSJ_AT_grenadier_dak";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_TL_X =			"LIB_FSJ_Soldier_2_dak";				//initHQ\createpatrol.sqf, initHQ\guards.sqf
blufor_SOLDIER_SL_X =			"LIB_FSJ_NCO_dak";						//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"LIB_FSJ_Mgunner_dak";					//support\paradrop.sqf, initHQ\guards.sqf
blufor_MARKSMAN_X = 			"LIB_FSJ_Sniper_dak";					//initHQ\guards.sqf
blufor_OFFICER_X =				"LIB_FSJ_Lieutenant_dak";				//initHQ\BluHQinit.sqf
...
blufor_PLANE_FIGHTER_X =		"LIB_FW190F8_Italy";						//dialog\request_hcATTchop.sqf, random patrol
...
blufor_SPECOPS_X =				"LIB_FSJ_soldier_dak";					//operator
blufor_SPECOPS_GL_X =			"LIB_FSJ_AT_grenadier_dak";				//operator
blufor_SPECOPS_LAT_X =			"LIB_FSJ_AT_soldier_dak";				//operator
blufor_SPECOPS_HAT_X =			"LIB_FSJ_AT_soldier_dak";				//operator
blufor_SPECOPS_AA_X =			"LIB_FSJ_radioman_dak";					//operator
blufor_SPECOPS_AR_X =			"LIB_FSJ_Soldier_2_dak";				//operator Dang Edit
blufor_SPECOPS_MG_X =			"LIB_FSJ_Mgunner_dak";					//operator
blufor_SPECOPS_MEDIC_X =		"LIB_FSJ_medic_dak";					//operator
blufor_SPECOPS_MARK_X =			"LIB_FSJ_Sniper_dak";					//operator
blufor_SPECOPS_SNIPER_X =		"LIB_FSJ_Sniper_dak";					//operator
blufor_SPECOPS_EXP_X =			"LIB_FSJ_sapper_dak";					//operator
blufor_SPECOPS_ENG_X = 			"LIB_FSJ_sapper_gefr_dak";				//operator
blufor_SPECOPS_SL_X = 			"LIB_FSJ_Lieutenant_dak";				//operator Lt.Dang edit
blufor_SPECOPS_TL_X = 			"LIB_FSJ_NCO_dak";						//operator Lt.Dang edit
blufor_SPECOPS_ASS_X = 			"LIB_FSJ_NCO_dak";						//operator Lt.Dang edit
...
blufor_RQST_UNIT_01_X = 			["LIB_FSJ_soldier_dak","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["LIB_FSJ_AT_grenadier_dak","Grenadier  (3CP)",3];
blufor_RQST_UNIT_03_X =				["LIB_FSJ_Soldier_2_dak","FG42 gunner (3CP)",3];
blufor_RQST_UNIT_04_X =				["LIB_FSJ_Mgunner_dak","MG42 gunner (4CP)",4];
blufor_RQST_UNIT_05_X =				["LIB_FSJ_medic_dak","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["LIB_FSJ_AT_grenadier_dak","AT Soldier (4CP)",4];
blufor_RQST_UNIT_07_X =				["LIB_FSJ_radioman_dak","Radioman (2CP)",2];
blufor_RQST_UNIT_08_X =				["LIB_FSJ_sapper_dak","Engineer (4CP)",4];
blufor_RQST_UNIT_09_X =				["LIB_FSJ_Sniper_dak","Sniper (3CP)",3];
