...
blufor_SPECOPS_X =				"uns_men_USMC_65_RF2";			//operator
blufor_SPECOPS_GL_X =			"uns_men_USMC_65_GL";			//operator
blufor_SPECOPS_LAT_X =			"uns_men_USMC_65_AT";			//operator
blufor_SPECOPS_HAT_X =			"uns_men_USMC_65_AT";			//operator
blufor_SPECOPS_AA_X =			"uns_men_USMC_65_RTO";			//operator
blufor_SPECOPS_MG_X =			"uns_men_USMC_65_HMG";			//operator
blufor_SPECOPS_MEDIC_X =		"uns_men_USMC_65_MED";			//operator
blufor_SPECOPS_MARK_X =			"uns_men_USMC_65_MRK";			//operator
blufor_SPECOPS_SNIPER_X =		"uns_men_USMC_65_MRK2";			//operator
blufor_SPECOPS_EXP_X =			"uns_men_USMC_65_DEM";			//operator
blufor_SPECOPS_ENG_X = 			"uns_men_USMC_65_ENG";			//operator
blufor_SPECOPS_SL_X = 			"uns_men_USMC_65_TL";			//operator Dang
blufor_SPECOPS_PL_X = 			"uns_men_USMC_65_PL";			//operator Dang
blufor_SPECOPS_ASS_X = 			"uns_men_USMC_65_SCT";			//operator Dang
