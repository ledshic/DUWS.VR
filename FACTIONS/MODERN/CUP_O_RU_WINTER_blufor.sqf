...
blufor_SOLDIER_X =				"CUP_O_RU_Soldier_Ratnik_Winter";				//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"CUP_O_RU_Soldier_AT_Ratnik_Winter";			//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"CUP_O_RU_Soldier_GL_Ratnik_Winter";			//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"CUP_O_RU_Soldier_TL_Ratnik_Winter";			//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"CUP_O_RU_Soldier_SL_Ratnik_Winter";			//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"CUP_O_RU_Soldier_MG_Ratnik_Winter";			//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"CUP_O_RU_Soldier_Marksman_Ratnik_Winter";		//initHQ\fnc_HQguards
blufor_OFFICER_X =				"CUP_O_RU_Officer";								//initHQ\fnc_BluHQinit
...
blufor_APC_PATROL1_X =			"CUP_O_BTR80A_WINTER_RU";		//random patrol
...
blufor_RQST_UNIT_01_X = 			["CUP_O_RU_Soldier_Ratnik_Winter","Rifleman (Winter) (2CP)",2];
blufor_RQST_UNIT_02_X =				["CUP_O_RU_Soldier_GL_Ratnik_Winter","Grenadier (Winter) (3CP)",3];
blufor_RQST_UNIT_03_X =				["CUP_O_RU_Soldier_AR_Ratnik_Winter","Automatic Rifleman (Winter) (3CP)",3];
blufor_RQST_UNIT_04_X =				["CUP_O_RU_Soldier_MG_Ratnik_Winter","Heavy Gunner (Winter) (4CP)",4];
blufor_RQST_UNIT_05_X =				["CUP_O_RU_Soldier_Medic_Ratnik_Winter","Medic (Winter) (4CP)",4];
blufor_RQST_UNIT_06_X =				["CUP_O_RU_Soldier_AT_Ratnik_Winter","AT Rifleman (Winter) (3CP)",3];
blufor_RQST_UNIT_07_X =				["CUP_O_RU_Soldier_HAT_Ratnik_Winter","AT Specialist (Winter) (4CP)",4];
blufor_RQST_UNIT_08_X =				["CUP_O_RU_Soldier_AA_Ratnik_Winter","AA Specialist (Winter) (4CP)",4];
blufor_RQST_UNIT_09_X =				["CUP_O_RU_Soldier_Engineer_Ratnik_Winter","Engineer (Winter) (4CP)",4];
blufor_RQST_UNIT_10_X =				["CUP_O_RU_Soldier_Exp_Ratnik_Winter","Explosive Specialist (Winter) (4CP)",4];
blufor_RQST_UNIT_11_X =				["CUP_O_RU_Soldier_Marksman_Ratnik_Winter","Marksman (Winter) (3CP)",3];
...
blufor_RQST_VEHICLE_19_X =			["CUP_O_BTR80_WINTER_RU","BTR-80 (35CP)",35];
blufor_RQST_VEHICLE_20_X =			["CUP_O_BTR80A_WINTER_RU","BTR-80A (35CP)",35];
