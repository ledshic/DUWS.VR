...
blufor_SOLDIER_X =				"OPTRE_UNSC_Army_Soldier_Rifleman_BR_WDL";				//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"OPTRE_UNSC_Army_Soldier_Rifleman_AT_WDL";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"OPTRE_UNSC_Army_Soldier_Grenadier_WDL";			//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"OPTRE_UNSC_Army_Soldier_TeamLead_WDL";			//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"OPTRE_UNSC_Army_Soldier_SquadLead_WDL";			//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"OPTRE_UNSC_Army_Soldier_Autorifleman_WDL";		//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"OPTRE_UNSC_Army_Soldier_Marksman_WDL";				//initHQ\fnc_HQguards
blufor_OFFICER_X =				"OPTRE_UNSC_Army_Soldier_Officer_WDL";				//initHQ\fnc_BluHQinit
blufor_HELI_PILOT_X	=			"OPTRE_UNSC_Airforce_Soldier_Airman";				//Rescue Pilot mission

blufor_BOAT_ARMED_X	=			"optre_catfish_mg_f";			//supports\taxi\fnc_boatTaxi
blufor_BOAT_CREW_X =			"OPTRE_UNSC_Marine_Soldier_Rifleman_AR";				//supports\taxi\fnc_boatTaxi
...
blufor_RQST_UNIT_01_X = 			["OPTRE_UNSC_Army_Soldier_Rifleman_BR_WDL","Rifleman (UNSC) (2CP)",2];
blufor_RQST_UNIT_02_X =				["OPTRE_UNSC_Army_Soldier_Grenadier_WDL","Grenadier (UNSC) (3CP)",3];
blufor_RQST_UNIT_03_X =				["OPTRE_UNSC_Army_Soldier_Rifleman_AR_WDL","Automatic Rifleman (UNSC) (3CP)",3];
blufor_RQST_UNIT_04_X =				["OPTRE_UNSC_Army_Soldier_Autorifleman_WDL","Heavy Gunner (UNSC) (4CP)",4];
blufor_RQST_UNIT_05_X =				["OPTRE_UNSC_Army_Soldier_Medic_WDL","Medic (UNSC) (4CP)",4];
blufor_RQST_UNIT_06_X =				["OPTRE_UNSC_Army_Soldier_Rifleman_AT_WDL","AT Rifleman (UNSC) (3CP)",3];
blufor_RQST_UNIT_07_X =				["OPTRE_UNSC_Army_Soldier_AT_Specialist_WDL","AT Specialist (UNSC) (4CP)",4];
blufor_RQST_UNIT_08_X =				["OPTRE_UNSC_Army_Soldier_AA_Specialist_WDL","AA Specialist (UNSC) (4CP)",4];
blufor_RQST_UNIT_09_X =				["OPTRE_UNSC_Army_Soldier_Engineer_WDL","Engineer (UNSC) (4CP)",4];
blufor_RQST_UNIT_10_X =				["OPTRE_UNSC_Army_Soldier_Marksman_WDL","Marksman (UNSC) (3CP)",3];
blufor_RQST_UNIT_11_X =				["OPTRE_UNSC_Army_Soldier_Sniper_WDL","Sniper (UNSC) (4CP)",4];
