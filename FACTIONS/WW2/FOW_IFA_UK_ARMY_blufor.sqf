...
///////////////
///////////////   "fow_uk", "FOW IFA UK ARMY","FOW_IFA_UK_ARMY"
///////////////
...
blufor_SOLDIER_X =				"fow_s_uk_rifleman";				//patrol, fortify
blufor_SOLDIER_LAT_X =			"fow_s_uk_at";						//initHQ\guards.sqf
blufor_SOLDIER_GL_X =			"fow_s_uk_at_asst";					//initHQ\guards.sqf 
blufor_SOLDIER_TL_X =			"fow_s_uk_teamleader";				//initHQ\createpatrol.sqf
blufor_SOLDIER_SL_X =			"fow_s_uk_section_commander";		//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"fow_s_uk_bren_gunner";				//initHQ\guards.sqf
blufor_MARKSMAN_X = 			"fow_s_uk_bren_asst";				//initHQ\guards.sqf
blufor_OFFICER_X =				"fow_s_uk_officer";					//initHQ\BluHQinit.sqf
...
blufor_BOAT_CREW_X =			"fow_s_uk_rifleman";				//support\taxi\boatTaxi.sqf
...
blufor_TANK_PATROL_X =			"LIB_Churchill_Mk7_Crocodile";		//random patrol
blufor_TANK_PATROL1_X =			"LIB_Churchill_Mk7_AVRE";			//random patrol Dang Edit
blufor_TANK_PATROL2_X =			"LIB_Churchill_Mk7_Howitzer";		//random patrol Dang Edit
blufor_TANK_PATROL3_X =			"LIB_Churchill_Mk7";				//random patrol Dang Edit
...
blufor_PARA_X =				"fow_s_uk_para_rifleman";			//support\paradrop.sqf		
blufor_PARA_AT_X =			"fow_s_uk_para_at";					//support\paradrop.sqf	
blufor_PARA_GL_X =			"fow_s_uk_para_at_asst";			//support\paradrop.sqf	
blufor_PARA_TL_X =			"fow_s_uk_para_section_commander";	//support\paradrop.sqf	
blufor_PARA_RAD_X =			"fow_s_uk_para_radio_operator";		//support\paradrop.sqf	
blufor_PARA_AR_X =			"fow_s_uk_para_bren_gunner";		//support\paradrop.sqf	
blufor_PARA_MED_X =			"fow_s_uk_para_medic";				//support\paradrop.sqf
...
blufor_SPECOPS_X =				"fow_s_uk_cdo_rifleman";			//operator
blufor_SPECOPS_GL_X =			"fow_s_uk_cdo_at_asst";				//operator
blufor_SPECOPS_LAT_X =			"fow_s_uk_cdo_at";					//operator
blufor_SPECOPS_HAT_X =			"fow_s_uk_cdo_at";					//operator
blufor_SPECOPS_AA_X =			"fow_s_uk_cdo_radio_operator";		//operator
blufor_SPECOPS_MG_X =			"fow_s_uk_cdo_bren_gunner";			//operator
blufor_SPECOPS_AR_X =			"fow_s_uk_cdo_bren_gunner";			//operator Dang Edit
blufor_SPECOPS_MEDIC_X =		"fow_s_uk_cdo_medic";				//operator
blufor_SPECOPS_MARK_X =			"fow_s_uk_cdo_bren_asst";			//operator
blufor_SPECOPS_SNIPER_X =		"fow_s_uk_cdo_bren_asst";			//operator
blufor_SPECOPS_EXP_X =			"fow_s_uk_cdo_at_asst";				//operator
blufor_SPECOPS_ENG_X = 			"fow_s_uk_cdo_at_asst";				//operator
blufor_SPECOPS_SL_X = 			"fow_s_uk_cdo_officer";				//operator Lt.Dang edit
blufor_SPECOPS_TL_X = 			"fow_s_uk_cdo_section_commander";	//operator Lt.Dang edit
blufor_SPECOPS_ASS_X = 			"fow_s_uk_cdo_teamleader";			//operator Lt.Dang edit
...
blufor_RQST_UNIT_01_X = 			["fow_s_uk_rifleman","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["fow_s_uk_at_asst","At Asst. (3CP)",3];
blufor_RQST_UNIT_03_X =				["fow_s_uk_teamleader","Corporal (2CP)",2];
blufor_RQST_UNIT_04_X =				["fow_s_uk_bren_gunner","Bren Gunner (4CP)",4];
blufor_RQST_UNIT_05_X =				["fow_s_uk_medic","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["fow_s_uk_at","AT Rifleman (3CP)",3];
blufor_RQST_UNIT_07_X =				["fow_s_uk_officer","Officer (2CP)",2];
blufor_RQST_UNIT_08_X =				["fow_s_uk_radio_operator","Radioman (2CP)",2];
blufor_RQST_UNIT_09_X =				["fow_s_uk_at_asst","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["fow_s_uk_section_commander","Sergeant (3CP)",3];
blufor_RQST_UNIT_11_X =				["fow_s_uk_bren_asst","Bren Asst. (4CP)",4];
