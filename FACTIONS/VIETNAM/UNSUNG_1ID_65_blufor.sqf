...
blufor_SOLDIER_X =				"uns_US_1ID_RF1";					//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"uns_US_1ID_AT";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_GL_X =			"uns_US_1ID_GL";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_TL_X =			"uns_US_1ID_SL";				//initHQ\createpatrol.sqf, initHQ\guards.sqf
blufor_SOLDIER_SL_X =			"uns_US_1ID_PL";				//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"uns_US_1ID_HMG";				//support\paradrop.sqf, initHQ\guards.sqf
blufor_MARKSMAN_X = 			"uns_US_1ID_MRK";				//initHQ\guards.sqf
blufor_OFFICER_X =				"uns_US_1ID_COM";				//initHQ\BluHQinit.sqf
...
blufor_STATIC_FLAG =			"uns_FlagCarrierUS";
...
blufor_RQST_UNIT_01_X = 			["uns_US_1ID_RF1","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["uns_US_1ID_GL","Grenadier (3CP)",3];
blufor_RQST_UNIT_03_X =				["uns_US_1ID_HMG","Machinegunner (3CP)",3];
blufor_RQST_UNIT_04_X =				["uns_US_1ID_RTO","Radio Operator (2CP)",4];
blufor_RQST_UNIT_05_X =				["uns_US_1ID_MED","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["uns_US_1ID_AT","AT Rifleman (3CP)",3];
blufor_RQST_UNIT_07_X =				["uns_US_1ID_SL","Squad Leader (2CP)",4];
blufor_RQST_UNIT_08_X =				["uns_US_1ID_DEM","Demolitions Expert (3CP)",4];
blufor_RQST_UNIT_09_X =				["uns_US_1ID_ENG","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["uns_US_1ID_MRK2","Marksman (3CP)",3];
blufor_RQST_UNIT_11_X =				["uns_US_1ID_MRK","Sniper (4CP)",4];
