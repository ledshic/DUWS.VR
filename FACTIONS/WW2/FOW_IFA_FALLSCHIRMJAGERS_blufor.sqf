...
///////////////
///////////////   "fow_luftwaffe", "FOW IFA FALLSCHIRMJAGERS (Europe)","FOW_IFA_FALLSCHIRMJAGERS"
///////////////
...
blufor_SOLDIER_X =				"fow_s_ger_luft_rifleman";			//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"LIB_FSJ_AT_soldier";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_GL_X =			"fow_s_ger_luft_rifleman_g43";		//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_TL_X =			"fow_s_ger_luft_tl_stg";			//initHQ\createpatrol.sqf, initHQ\guards.sqf
blufor_SOLDIER_SL_X =			"fow_s_ger_luft_tl_mp40";			//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"fow_s_ger_luft_mg42_gunner";		//support\paradrop.sqf, initHQ\guards.sqf
...
blufor_SPECOPS_X =				"fow_s_ger_luft_camo_mg42_sparebarrel";		//operator
blufor_SPECOPS_GL_X =			"fow_s_ger_luft_camo_rifleman_g43";			//operator
blufor_SPECOPS_LAT_X =			"fow_s_ger_luft_camo_rifleman_mp40_pzf";	//operator
blufor_SPECOPS_HAT_X =			"LIB_FSJ_AT_soldier";						//operator
blufor_SPECOPS_AA_X =			"fow_s_ger_luft_camo_radio_operator";		//operator
blufor_SPECOPS_MG_X =			"fow_s_ger_luft_camo_mg42_gunner";			//operator
blufor_SPECOPS_AR_X =			"fow_s_ger_luft_camo_mg34_gunner";			//operator Dang Edit
blufor_SPECOPS_MEDIC_X =		"fow_s_ger_luft_camo_medic";				//operator
...
blufor_SPECOPS_SL_X = 			"fow_s_ger_luft_camo_tl_stg";					//operator Lt.Dang edit
blufor_SPECOPS_TL_X = 			"fow_s_ger_luft_camo_tl_mp40";					//operator Lt.Dang edit
blufor_SPECOPS_ASS_X = 			"fow_s_ger_luft_camo_rifleman_fg42";				//operator Lt.Dang edit
...
blufor_RQST_UNIT_01_X = 			["fow_s_ger_luft_rifleman","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["fow_s_ger_luft_rifleman_g43","G43 Rifleman (3CP)",3];
blufor_RQST_UNIT_03_X =				["fow_s_ger_luft_mg34_gunner","MG34 gunner (3CP)",3];
blufor_RQST_UNIT_04_X =				["fow_s_ger_luft_mg42_gunner","MG42 gunner (4CP)",4];
blufor_RQST_UNIT_05_X =				["fow_s_ger_luft_medic","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["fow_s_ger_luft_rifleman_mp40_pzf","AT Soldier (4CP)",4];
blufor_RQST_UNIT_07_X =				["fow_s_ger_luft_radio_operator","Radioman (2CP)",2];
blufor_RQST_UNIT_08_X =				["LIB_FSJ_Sniper","Engineer (4CP)",4];
