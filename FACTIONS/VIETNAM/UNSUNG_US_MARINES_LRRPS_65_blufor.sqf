...
blufor_SOLDIER_X =				"uns_men_USMC_65_RF2";					//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"uns_men_USMC_65_AT";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_GL_X =			"uns_men_USMC_65_GL";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_TL_X =			"uns_men_USMC_65_SL";				//initHQ\createpatrol.sqf, initHQ\guards.sqf
blufor_SOLDIER_SL_X =			"uns_men_USMC_65_PL";				//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"uns_men_USMC_65_HMG";				//support\paradrop.sqf, initHQ\guards.sqf
blufor_MARKSMAN_X = 			"uns_men_USMC_65_MRK";				//initHQ\guards.sqf
blufor_OFFICER_X =				"uns_men_USMC_65_COM";				//initHQ\BluHQinit.sqf
...
blufor_SPECOPS_X =				"uns_men_US_5SFG_GL2";			//operator
blufor_SPECOPS_GL_X =			"uns_men_US_5SFG_GL";			//operator
blufor_SPECOPS_LAT_X =			"uns_men_US_5SFG_AT";			//operator
blufor_SPECOPS_HAT_X =			"uns_men_US_5SFG_AT";			//operator
blufor_SPECOPS_AA_X =			"uns_men_US_5SFG_RTO";			//operator
blufor_SPECOPS_MG_X =			"uns_men_US_5SFG_SP3";			//operator
blufor_SPECOPS_MEDIC_X =		"uns_men_US_5SFG_MED";			//operator
blufor_SPECOPS_MARK_X =			"uns_men_US_5SFG_MRK";			//operator
blufor_SPECOPS_SNIPER_X =		"uns_men_US_5SFG_MRK2";			//operator
blufor_SPECOPS_EXP_X =			"uns_men_US_5SFG_DEM";			//operator
blufor_SPECOPS_ENG_X = 			"uns_men_US_5SFG_ENG";			//operator
blufor_SPECOPS_SL_X = 			"uns_men_US_5SFG_SL";			//operator Dang
blufor_SPECOPS_PL_X = 			"uns_men_US_5SFG_PL";			//operator Dang
blufor_SPECOPS_ASS_X = 			"uns_men_US_1AC_TPR4";			//operator Dang
...
blufor_RQST_UNIT_01_X = 			["uns_men_USMC_65_RF2","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["uns_men_USMC_65_GL","Grenadier (3CP)",3];
blufor_RQST_UNIT_03_X =				["uns_men_USMC_65_HMG","Machinegunner (3CP)",3];
blufor_RQST_UNIT_04_X =				["uns_men_USMC_65_RTO","Radio Operator (2CP)",4];
blufor_RQST_UNIT_05_X =				["uns_men_USMC_65_MED","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["uns_men_USMC_65_AT","AT Rifleman (3CP)",3];
blufor_RQST_UNIT_07_X =				["uns_men_USMC_65_SL","Squad Leader (2CP)",4];
blufor_RQST_UNIT_08_X =				["uns_men_USMC_65_DEM","Demolitions Expert (3CP)",4];
blufor_RQST_UNIT_09_X =				["uns_men_USMC_65_ENG","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["uns_men_USMC_65_MRK","Sniper (3CP)",3];
