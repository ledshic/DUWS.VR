...
blufor_SPECOPS_X =				"uns_men_US_1AC_TPR2";			//operator
blufor_SPECOPS_GL_X =			"uns_men_US_1AC_GL2";			//operator
blufor_SPECOPS_LAT_X =			"uns_men_US_1AC_AT";			//operator
blufor_SPECOPS_HAT_X =			"uns_men_US_1AC_AT";			//operator
blufor_SPECOPS_AA_X =			"uns_men_US_1AC_RTO";			//operator
blufor_SPECOPS_MG_X =			"uns_men_US_1AC_HMG";			//operator
blufor_SPECOPS_MEDIC_X =		"uns_men_US_1AC_MED";			//operator
blufor_SPECOPS_MARK_X =			"uns_men_US_1AC_MRK3";			//operator
blufor_SPECOPS_SNIPER_X =		"uns_men_US_1AC_MRK";			//operator
blufor_SPECOPS_EXP_X =			"uns_men_US_1AC_DEM";			//operator
blufor_SPECOPS_ENG_X = 			"uns_men_US_1AC_ENG";			//operator
blufor_SPECOPS_SL_X = 			"uns_men_US_1AC_SL";			//operator Dang
blufor_SPECOPS_PL_X = 			"uns_men_US_1AC_PL";			//operator Dang
