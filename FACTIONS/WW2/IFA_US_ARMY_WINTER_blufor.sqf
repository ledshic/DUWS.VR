...
///////////////
///////////////   "LIB_US_ARMY_w", "IFA US ARMY (Winter)","IFA_US_ARMY_WINTER"
///////////////
...
blufor_SOLDIER_X =				"LIB_US_rifleman_w";				//patrol, fortify
blufor_SOLDIER_LAT_X =			"LIB_US_AT_soldier_w";				//initHQ\guards.sqf
blufor_SOLDIER_GL_X =			"LIB_US_grenadier_w";				//initHQ\guards.sqf 
blufor_SOLDIER_TL_X =			"LIB_US_second_lieutenant_w";		//initHQ\createpatrol.sqf
blufor_SOLDIER_SL_X =			"LIB_US_first_lieutenant_w";		//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"LIB_US_mgunner_w";					//initHQ\guards.sqf
blufor_MARKSMAN_X = 			"LIB_US_sniper_w";					//initHQ\guards.sqf
blufor_OFFICER_X =				"LIB_US_captain_w";					//initHQ\BluHQinit.sqf
...
blufor_BOAT_CREW_X =			"LIB_US_Driver_w";					//support\taxi\boatTaxi.sqf
...
blufor_SPECOPS_X =				"LIB_US_rifleman_w";				//operator
blufor_SPECOPS_GL_X =			"LIB_US_grenadier_w";				//operator
blufor_SPECOPS_LAT_X =			"LIB_US_AT_soldier_w";				//operator
blufor_SPECOPS_HAT_X =			"LIB_US_AT_soldier_w";				//operator
blufor_SPECOPS_AA_X =			"LIB_US_radioman_w";				//operator
blufor_SPECOPS_MG_X =			"LIB_US_mgunner_w";					//operator
blufor_SPECOPS_AR_X =			"LIB_US_mgunner_w";					//operator Dang Edit
blufor_SPECOPS_MEDIC_X =		"LIB_US_medic_w";					//operator
blufor_SPECOPS_MARK_X =			"LIB_US_sniper_w";					//operator
blufor_SPECOPS_SNIPER_X =		"LIB_US_sniper_w";					//operator
blufor_SPECOPS_EXP_X =			"LIB_US_engineer_w";				//operator
blufor_SPECOPS_ENG_X = 			"LIB_US_engineer_w";				//operator
blufor_SPECOPS_SL_X = 			"LIB_US_first_lieutenant_w";		//operator Lt.Dang edit
blufor_SPECOPS_TL_X = 			"LIB_US_second_lieutenant_w";		//operator Lt.Dang edit
blufor_SPECOPS_ASS_X = 			"LIB_US_Smgunner_w";				//operator Lt.Dang edit
...
blufor_RQST_UNIT_01_X = 			["LIB_US_rifleman_w","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["LIB_US_grenadier_w","Grenadier (3CP)",3];
blufor_RQST_UNIT_03_X =				["LIB_US_smgunner_w","SMG Soldier (2CP)",2];
blufor_RQST_UNIT_04_X =				["LIB_US_mgunner_w","Heavy Gunner (4CP)",4];
blufor_RQST_UNIT_05_X =				["LIB_US_medic_w","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["LIB_US_corporal_w","Corporal (2CP)",2];
blufor_RQST_UNIT_07_X =				["LIB_US_AT_soldier_w","AT Soldier (4CP)",4];
blufor_RQST_UNIT_08_X =				["LIB_US_radioman_w","Radioman (2CP)",2];
blufor_RQST_UNIT_09_X =				["LIB_US_engineer_w","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["LIB_US_first_lieutenant_w","1st Leiutenant (2CP)",2];
blufor_RQST_UNIT_11_X =				["LIB_US_sniper_w","Sniper (4CP)",4];
