...
_safeTracks = ["Airfight", "Emma", "Machine", "Norman", "Refugees", "This_ismy_Home", "War_isnot_over", "Wardaddy"];
_safeDurations = [180, 151, 201, 167, 159, 221, 217, 157];


_combatTracks = ["Beetfield", "Crossroads", "Ambush", "Still_inthis_Fight", "Tiger_battle", "Town_Square"];
_combatDurations = [312, 482, 126, 220, 371, 136];


_stealthTracks = ["I'm_Scared_Too", "On_lookout", "Refugees", "The_Apartment", "Wardaddy"];
_stealthDurations = [226, 183, 159, 57, 157];


_movingFastTracks = ["War_isnot_over", "Airfight", "April_1945", "This_ismy_Home", "Norman"];
_movingFastDurations = [217, 180, 234, 221, 167];
