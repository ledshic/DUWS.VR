...
blufor_SOLDIER_X =				"rhsusf_usmc_marpat_wd_rifleman";			//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"rhsusf_usmc_marpat_wd_smaw";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"rhsusf_usmc_marpat_wd_grenadier";			//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"rhsusf_usmc_marpat_wd_teamleader";			//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"rhsusf_usmc_marpat_wd_squadleader";		//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"rhsusf_usmc_marpat_wd_autorifleman_m249";	//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"rhsusf_usmc_marpat_wd_marksman";			//initHQ\fnc_HQguards
blufor_OFFICER_X =				"rhsusf_usmc_marpat_wd_officer";			//initHQ\fnc_BluHQinit
blufor_HELI_PILOT_X	=			"rhsusf_usmc_marpat_wd_helipilot";			//Rescue Pilot mission
...
blufor_SPECOPS_X =				"rhsusf_usmc_recon_marpat_wd_rifleman";			//operator
blufor_SPECOPS_GL_X =			"rhsusf_usmc_recon_marpat_wd_grenadier_m32";	//operator
blufor_SPECOPS_LAT_X =			"rhsusf_usmc_marpat_wd_smaw";		 			//operator 
blufor_SPECOPS_HAT_X =			"rhsusf_usmc_marpat_wd_javelin";				//operator
blufor_SPECOPS_AA_X =			"rhsusf_usmc_marpat_wd_stinger";				//operator
blufor_SPECOPS_MG_X =			"rhsusf_usmc_recon_marpat_wd_machinegunner";	//operator
blufor_SPECOPS_MEDIC_X =		"rhsusf_navy_sarc_w";				 			//operator
blufor_SPECOPS_MARK_X =			"rhsusf_usmc_recon_marpat_wd_marksman";			//operator
blufor_SPECOPS_SNIPER_X =		"rhsusf_usmc_recon_marpat_wd_sniper_M107";		//operator
blufor_SPECOPS_EXP_X =			"rhsusf_usmc_marpat_wd_explosives";				//operator
blufor_SPECOPS_ENG_X =			"rhsusf_usmc_marpat_wd_engineer"; 				//operator
...
blufor_RQST_UNIT_01_X = 			["rhsusf_usmc_marpat_wd_rifleman","Rifleman (USMC) (2CP)",2];
blufor_RQST_UNIT_02_X =				["rhsusf_usmc_marpat_wd_grenadier","Grenadier (USMC) (3CP)",3];
blufor_RQST_UNIT_03_X =				["rhsusf_usmc_marpat_wd_autorifleman_m249","Automatic Rifleman (USMC) (3CP)",3];
blufor_RQST_UNIT_04_X =				["rhsusf_usmc_marpat_wd_machinegunner","Heavy Gunner (USMC) (4CP)",4];
blufor_RQST_UNIT_05_X =				["rhsusf_navy_marpat_wd_medic","Medic (USMC) (4CP)",4];
blufor_RQST_UNIT_06_X =				["rhsusf_usmc_marpat_wd_smaw","AT Rifleman (USMC) (3CP)",3];
blufor_RQST_UNIT_07_X =				["rhsusf_usmc_marpat_wd_javelin","AT Specialist (USMC) (4CP)",4];
blufor_RQST_UNIT_08_X =				["rhsusf_usmc_marpat_wd_stinger","AA Specialist (USMC) (4CP)",4];
blufor_RQST_UNIT_09_X =				["rhsusf_usmc_marpat_wd_engineer","Engineer (USMC) (4CP)",4];
blufor_RQST_UNIT_10_X =				["rhsusf_usmc_marpat_wd_marksman","Marksman (USMC) (3CP)",3];
blufor_RQST_UNIT_11_X =				["rhsusf_usmc_marpat_wd_sniper","Sniper (USMC) (4CP)",4];
...
blufor_RQST_VEHICLE_05_X =			["rhsusf_m1043_w_s_m2","HMMWV HMG (15CP)",15];
blufor_RQST_VEHICLE_06_X =			["rhsusf_m1043_w_s_mk19","HMMWV GMG (20CP)",20];
blufor_RQST_VEHICLE_07_X =			["rhsusf_m1045_w_s","HMMWV TOW (25CP)",25];
blufor_RQST_VEHICLE_08_X =			["rhsusf_m1240a1_m2_usmc_wd","M-1240 Oshkosh HMG (16CP)",16];
