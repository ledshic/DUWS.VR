...
blufor_SOLDIER_X =				"sfp_m90w_rifleman_ak5";				//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"sfp_m90w_at_specialist_pskott86";		//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"sfp_m90w_gr";							//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"sfp_m90w_teamleader";					//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"sfp_m90w_squadleader";					//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"sfp_m90w_machinegunner_ksp58";			//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"sfp_m90w_marksman";					//initHQ\fnc_HQguards
blufor_OFFICER_X =				"sfp_m90w_officer";						//initHQ\fnc_BluHQinit
...
blufor_APC_PATROL2_X =			"sfp_strf90c";							//random patrol
...
blufor_SPECOPS_X =				"sfp_m90w_sog_ak5";						//operator
blufor_SPECOPS_GL_X =			"sfp_m90w_sog_teamleader";				//operator
blufor_SPECOPS_LAT_X =			"sfp_m90w_sog_at_specialist_rb57";		//operator
blufor_SPECOPS_HAT_X =			"sfp_m90w_sog_at_specialist_grg";		//operator
blufor_SPECOPS_AA_X =			"B_soldier_AA_F";						//operator
blufor_SPECOPS_MG_X =			"sfp_m90w_sog_machinegunner_ksp58";		//operator
blufor_SPECOPS_MEDIC_X =		"sfp_m90w_sog_medic";					//operator
blufor_SPECOPS_MARK_X =			"sfp_m90w_marksman";					//operator
blufor_SPECOPS_SNIPER_X =		"sfp_m90w_sog_sniper_ag90";				//operator
blufor_SPECOPS_EXP_X =			"sfp_m90w_sog_explosive_specialist";	//operator
blufor_SPECOPS_ENG_X = 			"sfp_m90w_engineer";					//operator
...
blufor_RQST_UNIT_01_X = 			["sfp_m90w_rifleman_ak5","Rifleman (Wood) (2CP)",2];
blufor_RQST_UNIT_02_X =				["sfp_m90w_gr","Grenadier (Wood) (3CP)",3];
blufor_RQST_UNIT_03_X =				["sfp_m90w_automaticrifleman_ksp90","Automatic Rifleman (Wood) (3CP)",3];
blufor_RQST_UNIT_04_X =				["sfp_m90w_machinegunner_ksp58","Heavy Gunner (Wood) (4CP)",4];
blufor_RQST_UNIT_05_X =				["sfp_m90w_medic","Medic (Wood) (4CP)",4];
blufor_RQST_UNIT_06_X =				["sfp_m90w_at_specialist_pskott86","Rifleman AT (Wood) (4CP)",4];
blufor_RQST_UNIT_07_X =				["sfp_m90w_at_specialist_grg86","AT Specialist (Wood) (4CP)",4];
blufor_RQST_UNIT_08_X =				["sfp_m90w_engineer","Engineer (Wood) (4CP)",4];
blufor_RQST_UNIT_09_X =				["sfp_m90w_marksman","Marksman (Wood) (3CP)",3];
blufor_RQST_UNIT_10_X =				["sfp_m90w_sniper","Sniper (Wood) (4CP)",4];
...
blufor_RQST_VEHICLE_17_X =			["sfp_strf90c","STRF-90C (35CP)",35];
blufor_RQST_VEHICLE_18_X =			["sfp_lvkv90c","LVKV-90 AA (35CP)",35];
