...
blufor_SOLDIER_X =				"rhs_msv_arifleman";			//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"rhs_msv_LAT";					//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"rhs_msv_grenadier";			//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"rhs_msv_junior_sergeant";		//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"rhs_msv_sergeant";				//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"rhs_msv_arifleman";			//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"rhs_msv_marksman";				//initHQ\fnc_HQguards
blufor_OFFICER_X =				"rhs_msv_officer";				//initHQ\fnc_BluHQinit
...
blufor_SPECOPS_AA_X =			"rhs_msv_aa";						//operator
...
blufor_SPECOPS_ENG_X = 			"rhs_msv_engineer";					//operator
...
blufor_RQST_UNIT_01_X = 			["rhs_msv_rifleman","Rifleman (Flora) (2CP)",2];
blufor_RQST_UNIT_02_X =				["rhs_msv_grenadier","Grenadier (Flora) (3CP)",3];
blufor_RQST_UNIT_03_X =				["rhs_msv_arifleman","Automatic Rifleman (Flora) (3CP)",3];
blufor_RQST_UNIT_04_X =				["rhs_msv_machinegunner","Heavy Gunner (Flora) (4CP)",4];
blufor_RQST_UNIT_05_X =				["rhs_msv_medic","Medic (Flora) (4CP)",4];
blufor_RQST_UNIT_06_X =				["rhs_msv_LAT","AT Rifleman (Flora) (3CP)",3];
blufor_RQST_UNIT_07_X =				["rhs_msv_grenadier_rpg","AT Specialist (Flora) (4CP)",4];
blufor_RQST_UNIT_08_X =				["rhs_msv_aa","AA Specialist (Flora) (4CP)",4];
blufor_RQST_UNIT_09_X =				["rhs_msv_engineer","Engineer (Flora) (4CP)",4];
blufor_RQST_UNIT_10_X =				["rhs_msv_marksman","Marksman (Flora) (3CP)",3];
