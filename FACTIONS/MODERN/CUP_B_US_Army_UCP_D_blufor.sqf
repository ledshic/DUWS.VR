...
///////////////
///////////////   "CUP_B_US_Army", "CUP US Army Desert", "CUP_B_US_Army_D"
///////////////
...
blufor_CAR_PATROL1_X =			"CUP_B_HMMWV_M2_GPK_USA";		//random patrol
blufor_APC_PATROL1_X =			"CUP_B_M1126_ICV_M2_Desert";	//random patrol
blufor_APC_PATROL2_X =			"CUP_B_M2A3Bradley_USA_D";		//random patrol
blufor_TANK_PATROL1_X =			"CUP_B_M1A1_DES_US_Army";		//random patrol
...
blufor_RQST_VEHICLE_04_X =			["CUP_B_HMMWV_Unarmed_USA","HMMWV Unarmed (5CP)",5];
blufor_RQST_VEHICLE_05_X =			["CUP_B_HMMWV_Transport_USA","HMMWV Transport (8CP)",8];
blufor_RQST_VEHICLE_06_X =			["CUP_B_HMMWV_M2_GPK_USA","HMMWV HMG (18CP)",18];
blufor_RQST_VEHICLE_07_X =			["CUP_B_HMMWV_Crows_MK19_USA","HMMWV GMG crows (25CP)",25];
blufor_RQST_VEHICLE_08_X =			["CUP_B_RG31_M2_USA","RG-31 HMG (10CP)",10];
blufor_RQST_VEHICLE_09_X =			["CUP_B_RG31_Mk19_USA","RG-31 GMG (18CP)",18];
blufor_RQST_VEHICLE_10_X =			["CUP_B_RG31E_M2_USA","RG-31 Mk5E (25CP)",25];
...
blufor_RQST_VEHICLE_18_X =			["CUP_B_M1130_CV_M2_Desert","M1130 CV HMG (35CP)",35];
blufor_RQST_VEHICLE_19_X =			["CUP_B_M1135_ATGMV_Desert","M1135 ATGMV (35CP)",35];
blufor_RQST_VEHICLE_20_X =			["CUP_B_M2A3Bradley_USA_D","Bradley ERA (35CP)",35];
blufor_RQST_VEHICLE_21_X =			["CUP_B_M7Bradley_USA_D","Bradley M7 (35CP)",35];
blufor_RQST_VEHICLE_22_X =			["CUP_B_M1A1_DES_US_Army","M1A1 Tank  (40CP)",40];
blufor_RQST_VEHICLE_23_X =			["CUP_B_M1A2_TUSK_MG_DES_US_Army","M1A2 TUSK (40CP)",40];
blufor_RQST_VEHICLE_24_X =			["CUP_B_Challenger2_NATO","NATO Challenger Tank (50CP)",50];
blufor_RQST_VEHICLE_25_X =			["CUP_B_M1129_MC_MK19_Desert","M1129 Mortar GMG (50CP)",50];
