...
blufor_SOLDIER_X =				"uns_men_NVA_65_RF1";				//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"uns_men_NVA_65_AT2";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_GL_X =			"uns_men_NVA_65_RF3";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_TL_X =			"uns_men_NVA_65_nco";				//initHQ\createpatrol.sqf, initHQ\guards.sqf
blufor_SOLDIER_SL_X =			"uns_men_NVA_65_off";				//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"uns_men_NVA_65_HMG";				//support\paradrop.sqf, initHQ\guards.sqf
blufor_MARKSMAN_X = 			"uns_men_NVA_65_MRK";				//initHQ\guards.sqf
blufor_OFFICER_X =				"uns_men_NVA_65_COM";				//initHQ\BluHQinit.sqf
...
blufor_SPECOPS_X =				"uns_men_NVA_recon_65_AS3";			//operator
blufor_SPECOPS_GL_X =			"uns_men_NVA_recon_65_AS1";			//operator
blufor_SPECOPS_LAT_X =			"uns_men_NVA_recon_65_AT";			//operator
blufor_SPECOPS_HAT_X =			"uns_men_NVA_recon_65_AT2";			//operator
blufor_SPECOPS_AA_X =			"uns_men_NVA_65_AA";				//operator
blufor_SPECOPS_MG_X =			"uns_men_NVA_recon_65_HMG";			//operator
blufor_SPECOPS_MEDIC_X =		"uns_men_NVA_recon_65_MED";			//operator
blufor_SPECOPS_MARK_X =			"uns_men_NVA_recon_65_MRK";			//operator
blufor_SPECOPS_SNIPER_X =		"uns_men_NVA_recon_65_MRK";			//operator
blufor_SPECOPS_EXP_X =			"uns_men_NVA_recon_65_SAP";			//operator
blufor_SPECOPS_ENG_X = 			"uns_men_NVA_recon_65_SAP";			//operator
blufor_SPECOPS_SL_X = 			"uns_men_NVA_recon_65_nco";			//operator Dang
blufor_SPECOPS_PL_X = 			"uns_men_NVA_recon_65_off";			//operator Dang
...
blufor_RQST_UNIT_01_X = 			["uns_men_NVA_65_RF1","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["uns_men_NVA_recon_65_RTO","Radio Operator (2CP)",2];
blufor_RQST_UNIT_03_X =				["uns_men_NVA_65_LMG","Automatic Rifleman (3CP)",3];
blufor_RQST_UNIT_04_X =				["uns_men_NVA_65_HMG","Heavy Gunner (4CP)",4];
blufor_RQST_UNIT_05_X =				["uns_men_NVA_65_MED","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["uns_men_NVA_65_AT","L-AT Rifleman (3CP)",3];
blufor_RQST_UNIT_07_X =				["uns_men_NVA_65_AT2","H-AT Rifleman (4CP)",4];
blufor_RQST_UNIT_08_X =				["uns_men_NVA_65_AA","AA Specialist (4CP)",4];
blufor_RQST_UNIT_09_X =				["uns_men_NVA_65_SAP","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["uns_men_NVA_65_MRK","Marksman (3CP)",3];
