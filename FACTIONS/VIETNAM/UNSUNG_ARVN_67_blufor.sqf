...
blufor_SOLDIER_X =				"uns_men_ARVN_RF4";					//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"uns_US_ARVN_AT";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_GL_X =			"uns_US_ARVN_GL";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_TL_X =			"uns_US_ARVN_SL";				//initHQ\createpatrol.sqf, initHQ\guards.sqf
blufor_SOLDIER_SL_X =			"uns_US_ARVN_PL";				//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"uns_US_ARVN_HMG";				//support\paradrop.sqf, initHQ\guards.sqf
blufor_MARKSMAN_X = 			"uns_US_ARVN_MRK";				//initHQ\guards.sqf
blufor_OFFICER_X =				"uns_US_ARVN_COM";				//initHQ\BluHQinit.sqf
...
blufor_HELI_TRANS_ARM_X =		"uns_UH1D_vnaf_m60";			//support\taxi\helotaxi.sqf, random patrol
blufor_HELI_TRANS_UNARM_X =		"uns_ch34_VNAF";   				//random patrol
...
blufor_PLANE_CAS_X =			"uns_A1H_CAS";					//dialog\request_hcCAS.sqf
blufor_PLANE_FIGHTER_X =		"uns_F4E_CHICO";				//dialog\request_hcCAS1.sqf Dang
blufor_PLANE_PATROL_X = 		"uns_A1H_CMU";					//random patrol Dang
blufor_PLANE_PATROL1_X = 		"uns_A1H_EHCAS";				//random patrol Dang
...
blufor_CAR_PATROL1_X =			"uns_willys_2_m1919_arvn";		//random patrol
blufor_APC_PATROL1_X =			"uns_m163";						//random patrol
blufor_APC_PATROL2_X =			"uns_M113A1_M60";				//random patrol
blufor_APC_PATROL3_X =			"uns_xm706e1";					//random patrol Dang
blufor_APC_PATROL4_X =			"uns_xm706e1";					//random patrol Dang
blufor_APC_PATROL5_X =			"uns_M113A1_XM182";				//random patrol Dang
blufor_APC_PATROL6_X =			"uns_M132";						//random patrol Dang
...
blufor_STATIC_FLAG =			"uns_FlagCarrierSVN";
...
blufor_SPECOPS_X =				"uns_US_CIDG_s9";			//operator
blufor_SPECOPS_GL_X =			"uns_US_CIDGci_GL";			//operator
blufor_SPECOPS_LAT_X =			"uns_US_CIDG_AT";			//operator
blufor_SPECOPS_HAT_X =			"uns_US_CIDG_AT";			//operator
blufor_SPECOPS_AA_X =			"uns_US_CIDG_RTO";			//operator
blufor_SPECOPS_MG_X =			"uns_US_CIDG_HMG";			//operator
blufor_SPECOPS_MEDIC_X =		"uns_US_CIDGci_MED";			//operator
blufor_SPECOPS_MARK_X =			"uns_US_CIDG_MRK2";			//operator
blufor_SPECOPS_SNIPER_X =		"uns_US_CIDG_MRK3";			//operator
blufor_SPECOPS_EXP_X =			"uns_US_CIDGci_DEM";			//operator
blufor_SPECOPS_ENG_X = 			"uns_US_CIDGci_ENG";			//operator
blufor_SPECOPS_SL_X = 			"uns_US_CIDG_SL";			//operator Dang
blufor_SPECOPS_PL_X = 			"uns_US_CIDGci_PL";			//operator Dang
blufor_SPECOPS_ASS_X = 			"uns_US_CIDG_S4";			//operator Dang
...
blufor_RQST_UNIT_01_X = 			["uns_US_ARVN_RF1","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["uns_US_ARVN_GL","Grenadier (3CP)",3];
blufor_RQST_UNIT_03_X =				["uns_US_ARVN_HMG","Machinegunner (3CP)",3];
blufor_RQST_UNIT_04_X =				["uns_US_ARVN_RTO","Radio Operator (2CP)",4];
blufor_RQST_UNIT_05_X =				["uns_US_ARVN_MED","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["uns_US_ARVN_AT","AT Rifleman (3CP)",3];
blufor_RQST_UNIT_07_X =				["uns_US_ARVN_SL","Squad Leader (2CP)",4];
blufor_RQST_UNIT_08_X =				["uns_US_ARVN_DEM","Demolitions Expert (3CP)",4];
blufor_RQST_UNIT_09_X =				["uns_US_ARVN_ENG","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["uns_US_ARVN_MRK2","Marksman (3CP)",3];
blufor_RQST_UNIT_11_X =				["uns_US_ARVN_MRK","Sniper (4CP)",4];
...
blufor_RQST_VEHICLE_01_X =			["uns_willys_2_arvn","Willy's Jeep (1CP)",1];
blufor_RQST_VEHICLE_02_X =			["uns_willys_2_m60_arvn","Willy's Jeep M60 (2CP)",2];
blufor_RQST_VEHICLE_03_X =			["uns_willys_2_m1919_arvn","Willy's Jeep M1919 (4CP)",4];
...
blufor_RQST_VEHICLE_33_X =			["uns_UH1D_vnaf_m60_light","UH-1D Iroquois Slick light (20CP)",20];
blufor_RQST_VEHICLE_34_X =			["uns_UH1D_vnaf_m60","UH-1D Iroquois Slick (25CP)",25];
blufor_RQST_VEHICLE_35_X =			["uns_ch34_VNAF","CH-34 Chocktaw (28CP)",28];
