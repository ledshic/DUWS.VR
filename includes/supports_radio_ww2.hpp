...
class CfgCommunicationMenu
{
    class artillery
    {
        ...
        expression = "[6, 100, 8, 3, 1, 4, 'Sh_155mm_AMOS'] spawn fnc_mapclickarty"; // Code executed upon activation (ignored when the submenu is not empty)
    ...
    class jdam
    {
        text = "$STR_DUWS_X_qskapqt7"; // Text displayed in the menu and in a notification
        submenu = ""; // Submenu opened upon activation
		//_null = [salvos, radius, interval between salvos(in seconds), rounds per salvo, support type, CP cost, ammotype]
    ...
    class uav_recon
    {
        text = "$STR_DUWS_X_6ur7ueyi"; // Text displayed in the menu and in a notification
        submenu = ""; // Submenu opened upon activation
	...
	class hc_ATTchop
    {
        text = "$STR_DUWS_X_fq89nk8d"; // Text displayed in the menu and in a notification
        submenu = ""; // Submenu opened upon activation
	...
	class hc_CAS
    {
        text = "$STR_DUWS_X_byyqsj3b"; // Text displayed in the menu and in a notification
        submenu = ""; // Submenu opened upon activation
