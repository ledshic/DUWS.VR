...
blufor_SOLDIER_X =				"CUP_O_SLA_Soldier_Backpack_desert";		//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"CUP_O_sla_Soldier_AT_desert";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"CUP_O_sla_Soldier_GL_desert";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"CUP_O_sla_Soldier_SL_desert";				//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"CUP_O_sla_Soldier_SL_desert";				//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"CUP_O_sla_Soldier_AR_desert";				//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"CUP_O_sla_Sniper_desert";					//initHQ\fnc_HQguards
blufor_OFFICER_X =				"CUP_O_sla_Officer_desert";					//initHQ\fnc_BluHQinit
...
blufor_SPECOPS_X =				"CUP_O_SLA_Soldier_Backpack_desert";	//operator
blufor_SPECOPS_GL_X =			"CUP_O_sla_Soldier_GL_desert";			//operator
blufor_SPECOPS_LAT_X =			"CUP_O_sla_Soldier_AT_desert";			//operator
blufor_SPECOPS_HAT_X =			"CUP_O_sla_Soldier_HAT_desert";			//operator
blufor_SPECOPS_AA_X =			"CUP_O_sla_Soldier_AA_desert";			//operator
blufor_SPECOPS_MG_X =			"CUP_O_sla_Soldier_MG_desert";			//operator
blufor_SPECOPS_MEDIC_X =		"CUP_O_sla_Medic_desert";				//operator
blufor_SPECOPS_MARK_X =			"CUP_O_sla_Sniper_desert";				//operator
blufor_SPECOPS_SNIPER_X =		"CUP_O_sla_Sniper_KSVK_desert";			//operator
blufor_SPECOPS_EXP_X =			"CUP_O_sla_SpecOps_Demo";				//operator
blufor_SPECOPS_ENG_X = 			"CUP_O_sla_Engineer_desert";			//operator
...
blufor_RQST_UNIT_01_X = 			["CUP_O_SLA_Soldier_Backpack_desert","Rifleman (SLA) (2CP)",2];
blufor_RQST_UNIT_02_X =				["CUP_O_sla_Soldier_GL_desert","Grenadier (SLA) (3CP)",3];
blufor_RQST_UNIT_03_X =				["CUP_O_sla_Soldier_AR_desert","Automatic Rifleman (SLA) (3CP)",3];
blufor_RQST_UNIT_04_X =				["CUP_O_sla_Soldier_MG_desert","Heavy Gunner (MTP) (SLA)",4];
blufor_RQST_UNIT_05_X =				["CUP_O_sla_Medic_desert","Medic (SLA) (4CP)",4];
blufor_RQST_UNIT_06_X =				["CUP_O_sla_Soldier_AT_desert","AT Rifleman (SLA) (3CP)",3];
blufor_RQST_UNIT_07_X =				["CUP_O_sla_Soldier_HAT_desert","AT Specialist (SLA) (4CP)",4];
blufor_RQST_UNIT_08_X =				["CUP_O_sla_Soldier_AA_desert","AA Specialist (SLA) (4CP)",4];
blufor_RQST_UNIT_09_X =				["CUP_O_sla_Engineer_desert","Engineer (SLA) (4CP)",4];
blufor_RQST_UNIT_10_X =				["CUP_O_SLA_Spotter_desert","Spotter (SLA) (3CP)",3];
blufor_RQST_UNIT_11_X =				["CUP_O_sla_Sniper_desert","Marksman/Sniper (SLA) (3CP)",3];
blufor_RQST_UNIT_12_X =				["CUP_O_sla_Sniper_KSVK_desert","Sniper (SLA) (4CP)",4];
...
blufor_RQST_VEHICLE_22_X =			["CUP_O_T55_SLA","T-55 Tank (40CP)",40];
