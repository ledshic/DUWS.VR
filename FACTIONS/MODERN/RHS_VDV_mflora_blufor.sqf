...
blufor_SOLDIER_X =				"rhs_vdv_mflora_rifleman";			//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"rhs_vdv_mflora_LAT";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"rhs_vdv_mflora_grenadier";			//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"rhs_vdv_mflora_junior_sergeant";	//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"rhs_vdv_mflora_sergeant";			//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"rhs_vdv_mflora_machinegunner";		//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"rhs_vdv_mflora_marksman";			//initHQ\fnc_HQguards
blufor_OFFICER_X =				"rhs_vdv_mflora_officer";			//initHQ\fnc_BluHQinit
...
blufor_SPECOPS_HAT_X =			"rhs_vdv_mflora_at";				//operator
blufor_SPECOPS_AA_X =			"rhs_vdv_mflora_aa";				//operator
...
blufor_SPECOPS_ENG_X = 			"rhs_vdv_mflora_engineer";			//operator
...
blufor_RQST_UNIT_01_X = 			["rhs_vdv_mflora_rifleman","Rifleman (mflora) (2CP)",2];
blufor_RQST_UNIT_02_X =				["rhs_vdv_mflora_grenadier","Grenadier (mflora) (3CP)",3];
blufor_RQST_UNIT_03_X =				["rhs_vdv_mflora_machinegunner","Heavy Gunner (mflora) (4CP)",4];
blufor_RQST_UNIT_04_X =				["rhs_vdv_mflora_medic","Medic (mflora) (4CP)",4];
blufor_RQST_UNIT_05_X =				["rhs_vdv_mflora_LAT","AT Rifleman (mflora) (3CP)",3];
blufor_RQST_UNIT_06_X =				["rhs_vdv_mflora_grenadier_rpg","AT Specialist (mflora) (4CP)",4];
blufor_RQST_UNIT_07_X =				["rhs_vdv_mflora_aa","AA Specialist (mflora) (4CP)",4];
blufor_RQST_UNIT_08_X =				["rhs_vdv_mflora_engineer","Engineer (mflora) (4CP)",4];
blufor_RQST_UNIT_09_X =				["rhs_vdv_mflora_marksman","Marksman (mflora) (3CP)",3];
