...
blufor_SPECOPS_X =				"uns_men_US_SEAL_AS1";			//operator
blufor_SPECOPS_GL_X =			"uns_men_US_SEAL_GL";			//operator
blufor_SPECOPS_LAT_X =			"uns_men_US_SEAL_AT";			//operator
blufor_SPECOPS_HAT_X =			"uns_men_US_SEAL_AT";			//operator
blufor_SPECOPS_AA_X =			"uns_men_US_SEAL_RTO";			//operator
blufor_SPECOPS_MG_X =			"uns_men_US_SEAL_LMG";			//operator
blufor_SPECOPS_MEDIC_X =		"uns_men_US_SEAL_MED";			//operator
blufor_SPECOPS_MARK_X =			"uns_men_US_SEAL_MRK";			//operator
blufor_SPECOPS_SNIPER_X =		"uns_men_US_SEAL_MRK2";			//operator
blufor_SPECOPS_EXP_X =			"uns_men_US_SEAL_DEM";			//operator
blufor_SPECOPS_ENG_X = 			"uns_men_US_SEAL_DEM";			//operator
blufor_SPECOPS_SL_X = 			"uns_men_US_SEAL_INT";			//operator Dang
blufor_SPECOPS_PL_X = 			"uns_men_US_SEAL_TL";			//operator Dang
blufor_SPECOPS_ASS_X = 			"uns_men_US_SEAL_AS3";			//operator Dang
