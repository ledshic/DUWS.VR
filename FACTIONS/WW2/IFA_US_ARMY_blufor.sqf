...
blufor_SOLDIER_X =				"LIB_US_rifleman";					//patrol, fortify
blufor_SOLDIER_LAT_X =			"LIB_US_AT_soldier";				//initHQ\guards.sqf
blufor_SOLDIER_GL_X =			"LIB_US_grenadier";					//initHQ\guards.sqf 
blufor_SOLDIER_TL_X =			"LIB_US_second_lieutenant";			//initHQ\createpatrol.sqf
blufor_SOLDIER_SL_X =			"LIB_US_first_lieutenant";			//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"LIB_US_mgunner";					//initHQ\guards.sqf
blufor_MARKSMAN_X = 			"LIB_US_sniper";					//initHQ\guards.sqf
blufor_OFFICER_X =				"LIB_US_captain";					//initHQ\BluHQinit.sqf
...
blufor_TANK_PATROL2_X =			"LIB_M4A3_75";						//random patrol Dang Edit
blufor_TANK_PATROL3_X =			"LIB_M4A3_75_Tubes";				//random patrol Dang Edit
...
blufor_SPECOPS_X =				"LIB_US_Rangers_rifleman";				//operator
blufor_SPECOPS_GL_X =			"LIB_US_Rangers_grenadier";				//operator
blufor_SPECOPS_LAT_X =			"LIB_US_Rangers_AT_soldier";			//operator
blufor_SPECOPS_HAT_X =			"LIB_US_Rangers_AT_soldier";			//operator
blufor_SPECOPS_AA_X =			"LIB_US_Rangers_radioman";				//operator
blufor_SPECOPS_MG_X =			"LIB_US_Rangers_mgunner";				//operator
blufor_SPECOPS_AR_X =			"LIB_US_Rangers_mgunner";				//operator Dang Edit
blufor_SPECOPS_MEDIC_X =		"LIB_US_Rangers_medic";					//operator
blufor_SPECOPS_MARK_X =			"LIB_US_Rangers_sniper";				//operator
blufor_SPECOPS_SNIPER_X =		"LIB_US_Rangers_sniper";				//operator
blufor_SPECOPS_EXP_X =			"LIB_US_Rangers_engineer";				//operator
blufor_SPECOPS_ENG_X = 			"LIB_US_Rangers_engineer";				//operator
blufor_SPECOPS_SL_X = 			"LIB_US_Rangers_first_lieutenant";		//operator Lt.Dang edit
blufor_SPECOPS_TL_X = 			"LIB_US_Rangers_second_lieutenant";		//operator Lt.Dang edit
blufor_SPECOPS_ASS_X = 			"LIB_US_Rangers_smgunner";				//operator Lt.Dang edit
...
blufor_RQST_UNIT_01_X = 			["LIB_US_rifleman","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["LIB_US_grenadier","Grenadier (3CP)",3];
blufor_RQST_UNIT_03_X =				["LIB_US_smgunner","SMG Soldier (2CP)",2];
blufor_RQST_UNIT_04_X =				["LIB_US_mgunner","Heavy Gunner (4CP)",4];
blufor_RQST_UNIT_05_X =				["LIB_US_medic","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["LIB_US_corporal","Corporal (2CP)",2];
blufor_RQST_UNIT_07_X =				["LIB_US_AT_soldier","AT Specialist (4CP)",4];
blufor_RQST_UNIT_08_X =				["LIB_US_radioman","Radioman (2CP)",2];
blufor_RQST_UNIT_09_X =				["LIB_US_engineer","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["LIB_US_first_lieutenant","1st Leiutenant (2CP)",2];
