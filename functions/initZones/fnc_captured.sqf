...
if (!_blufor_close) exitWith {
	...
	_trg setTriggerStatements["this", format["[""%1"",%2,""%3"",""%4"",%5,%6] spawn fnc_captured",_place,_points,_markername,_markername2,_triggerPos,_radius], ""];
};
*/
...
// ADD COMMAND POINTS  1000m zone = 100 / 2 = 50 pts available
