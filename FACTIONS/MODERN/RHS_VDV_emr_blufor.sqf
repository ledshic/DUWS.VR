...
blufor_SOLDIER_X =				"rhs_vdv_rifleman";				//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"rhs_vdv_LAT";					//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"rhs_vdv_grenadier";			//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"rhs_vdv_junior_sergeant";		//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"rhs_vdv_sergeant";				//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"rhs_vdv_arifleman";			//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"rhs_vdv_marksman";				//initHQ\fnc_HQguards
blufor_OFFICER_X =				"rhs_vdv_officer";				//initHQ\fnc_BluHQinit
...
blufor_HELI_TRANS_ARM_X =		"RHS_Mi8MTV3_vdv";				//supports\taxi\fnc_helotaxi, random patrol
blufor_HELI_TRANS_UNARM_X =		"rhs_ka60_c";   				//andom patrol
...
blufor_CAR_PATROL1_X =			"rhs_tigr_sts_vdv";				//random patrol
blufor_APC_PATROL1_X =			"rhs_btr80_vdv";				//random patrol
blufor_APC_PATROL2_X =			"rhs_bmp3_late_msv";			//random patrol
...
blufor_SPECOPS_AA_X =			"rhs_vdv_aa";						//operator
...
blufor_SPECOPS_ENG_X = 			"rhs_vdv_engineer";					//operator
...
blufor_RQST_UNIT_01_X = 			["rhs_vdv_rifleman","Rifleman (EMR) (2CP)",2];
blufor_RQST_UNIT_02_X =				["rhs_vdv_grenadier","Grenadier (EMR) (3CP)",3];
blufor_RQST_UNIT_03_X =				["rhs_vdv_arifleman","Automatic Rifleman (EMR) (3CP)",3];
blufor_RQST_UNIT_04_X =				["rhs_vdv_machinegunner","Heavy Gunner (EMR) (4CP)",4];
blufor_RQST_UNIT_05_X =				["rhs_vdv_medic","Medic (EMR) (4CP)",4];
blufor_RQST_UNIT_06_X =				["rhs_vdv_LAT","AT Rifleman (EMR) (3CP)",3];
blufor_RQST_UNIT_07_X =				["rhs_vdv_grenadier_rpg","AT Specialist (EMR) (4CP)",4];
blufor_RQST_UNIT_08_X =				["rhs_vdv_aa","AA Specialist (EMR) (4CP)",4];
blufor_RQST_UNIT_09_X =				["rhs_vdv_engineer","Engineer (EMR) (4CP)",4];
blufor_RQST_UNIT_10_X =				["rhs_vdv_marksman","Marksman (EMR) (3CP)",3];
...
blufor_RQST_VEHICLE_05_X =			["rhs_tigr_m_vdv","GAZ 233114 (15CP)",15];
blufor_RQST_VEHICLE_06_X =			["rhs_tigr_sts_vdv","GAZ HMG/GMG (25CP)",25];
...
blufor_RQST_VEHICLE_15_X =			["rhs_bmp1_vdv","BMP-1 (28CP)",25];
...
blufor_RQST_VEHICLE_26_X =			["RHS_Mi8mt_vdv","MI-8 MT HMG (26CP)",26];
blufor_RQST_VEHICLE_27_X =			["RHS_Mi8MTV3_vdv","MI-8 AMT Armed (30CP)",30];
blufor_RQST_VEHICLE_28_X =			["rhs_mi28n_vvsc","MI-28N Armed (35CP)",35];
blufor_RQST_VEHICLE_29_X =			["RHS_Mi24V_vdv","MI-24V Attack Heli (45CP)",45];
