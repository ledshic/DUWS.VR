...
blufor_SOLDIER_X =				"PLAFOR_Soldier";					//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"PLAFOR_Soldier_AT89B";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"PLAFOR_Soldier_GL";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"PLAFOR_Soldier_TL";				//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"PLAFOR_Soldier_SL";				//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"PLAFOR_Soldier_HMG";				//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"PLAFOR_Soldier_mk";				//initHQ\fnc_HQguards
blufor_OFFICER_X =				"PLAFOR_Soldier_OF";				//initHQ\fnc_BluHQinit
...
blufor_HELI_TRANS_ARM_X =		"VME_PLA_Mi17";						//supports\taxi\fnc_helotaxi, random patrol
blufor_HELI_TRANS_UNARM_X =		"VME_PLA_z9_CAS";   				//random patrol
blufor_HELI_ATTACK_X =			"VME_WZ10_FOR";						//dialog\fnc_request_hcATTchop, random patrol
...
blufor_SPECOPS_X =				"PLA_spec_FOR_base";					//operator
blufor_SPECOPS_GL_X =			"PLA_spec_FOR_GL";						//operator
blufor_SPECOPS_LAT_X =			"PLAFOR_Soldier_AT89B";					//operator
blufor_SPECOPS_HAT_X =			"PLAFOR_Soldier_AT";					//operator
blufor_SPECOPS_AA_X =			"PLAFOR_Soldier_AA";					//operator
blufor_SPECOPS_MG_X =			"PLAFOR_Soldier_HMG";					//operator
blufor_SPECOPS_MEDIC_X =		"PLA_spec_FOR_MEDIC";					//operator
blufor_SPECOPS_MARK_X =			"PLAFOR_Soldier_LR";					//operator
blufor_SPECOPS_SNIPER_X =		"PLA_spec_SNIPER";						//operator
blufor_SPECOPS_EXP_X =			"PLA_Soldier_special_4";				//operator
blufor_SPECOPS_ENG_X = 			"PLA_spec_FOR_ENG";						//operator
...
blufor_RQST_UNIT_01_X = 			["PLAFOR_Soldier","Rifleman (Forest) (2CP)",2];
blufor_RQST_UNIT_02_X =				["PLAFOR_Soldier_GL","Grenadier (Forest) (3CP)",3];
blufor_RQST_UNIT_03_X =				["PLAFOR_Soldier_MG","Automatic Rifleman (Forest) (3CP)",3];
blufor_RQST_UNIT_04_X =				["PLAFOR_Soldier_HMG","Heavy Gunner (Forest) (4CP)",4];
blufor_RQST_UNIT_05_X =				["PLAFOR_Soldier_medic","Medic (Forest) (4CP)",4];
blufor_RQST_UNIT_06_X =				["PLAFOR_Soldier_AT89B","AT Specialist (Forest) (4CP)",4];
blufor_RQST_UNIT_07_X =				["PLAFOR_Soldier_AA","AA Specialist (Forest) (4CP)",4];
blufor_RQST_UNIT_08_X =				["PLAFOR_Soldier_Engineer","Engineer (Forest) (4CP)",4];
blufor_RQST_UNIT_09_X =				["PLAFOR_Soldier_mk","Marksman (Forest) (3CP)",3];
blufor_RQST_UNIT_10_X =				["PLA_spec_SNIPER","Sniper (Forest) (4CP)",4];
...
blufor_RQST_VEHICLE_11_X =			["VME_PLA_SX2190","SX 2190 Transport Covered (8CP)",8];
blufor_RQST_VEHICLE_12_X =			["VME_PLA_SX2190Repair","SX 2190 Repair Truck(15CP)",15];
blufor_RQST_VEHICLE_13_X =			["VME_PLA_SX2190Reammo","SX 2190 Ammo Truck (15CP)",15];
blufor_RQST_VEHICLE_14_X =			["VME_PLA_SX2190Refuel","SX 2190 Fuel Truck (15CP)",15];
...
blufor_RQST_VEHICLE_18_X =			["O_T_APC_Wheeled_02_rcws_v2_ghex_F","MSE-3 Marid (25CP)",25];
...
blufor_RQST_VEHICLE_25_X =			["VME_PLA_HQ64","HQ 64 ADS (75CP)",75];
...
blufor_RQST_VEHICLE_29_X =			["VME_PLA_Mi17","Mi-17 Trans (25CP)",25];
blufor_RQST_VEHICLE_30_X =			["VME_PLA_Mi171","Mi-171 Gunship (30CP)",30];
blufor_RQST_VEHICLE_31_X =			["VME_WZ10_FOR","WZ-10 Attack Heli (45CP)",45];
