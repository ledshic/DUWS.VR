...
blufor_SOLDIER_X =				"UK3CB_CW_SOV_O_LATE_RIF_1";			//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"UK3CB_CW_SOV_O_LATE_LAT";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"UK3CB_CW_SOV_O_LATE_GL";				//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"UK3CB_CW_SOV_O_LATE_TL";				//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"UK3CB_CW_SOV_O_LATE_RADIO";			//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"UK3CB_CW_SOV_O_LATE_MG";				//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"UK3CB_CW_SOV_O_LATE_MK";				//initHQ\fnc_HQguards
...
blufor_BOAT_CREW_X =			"UK3CB_CW_SOV_O_LATE_RIF_1";			//supports\taxi\fnc_boatTaxi
...
blufor_RQST_UNIT_01_X = 			["UK3CB_CW_SOV_O_LATE_RIF_1","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["UK3CB_CW_SOV_O_LATE_LAT","Rifleman (AT) (3CP)",3];
blufor_RQST_UNIT_03_X =				["UK3CB_CW_SOV_O_LATE_GL","Grenadier (3CP)",3];
blufor_RQST_UNIT_04_X =				["UK3CB_CW_SOV_O_LATE_MG","Machinegunner (3CP)",3];
blufor_RQST_UNIT_05_X =				["UK3CB_CW_SOV_O_LATE_DEM","Explosive Specialist (4CP)",4];
blufor_RQST_UNIT_06_X =				["UK3CB_CW_SOV_O_LATE_MD","Medic (4CP)",4];
blufor_RQST_UNIT_07_X =				["UK3CB_CW_SOV_O_LATE_AT","AT Specialist (4CP)",4];
blufor_RQST_UNIT_08_X =				["UK3CB_CW_SOV_O_LATE_AA","AA Specialist (4CP)",4];
blufor_RQST_UNIT_09_X =				["UK3CB_CW_SOV_O_LATE_ENG","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["UK3CB_CW_SOV_O_LATE_MK","Marksman (3CP)",3];
blufor_RQST_UNIT_11_X =				["UK3CB_CW_SOV_O_LATE_CREW","Crewman (2CP)",4];
