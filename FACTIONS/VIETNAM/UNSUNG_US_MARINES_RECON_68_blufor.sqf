...
blufor_SOLDIER_X =				"uns_men_USMC_68_RF4";					//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"uns_men_USMC_68_AT";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_GL_X =			"uns_men_USMC_68_GL";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_TL_X =			"uns_men_USMC_68_SL";				//initHQ\createpatrol.sqf, initHQ\guards.sqf
blufor_SOLDIER_SL_X =			"uns_men_USMC_68_PL";				//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"uns_men_USMC_68_HMG";				//support\paradrop.sqf, initHQ\guards.sqf
blufor_MARKSMAN_X = 			"uns_men_USMC_68_MRK";				//initHQ\guards.sqf
blufor_OFFICER_X =				"uns_men_USMC_68_COM";				//initHQ\BluHQinit.sqf
...
blufor_HELI_TRANS_ARM_X =		"uns_UH1D_USMC_m60";			//support\taxi\helotaxi.sqf, random patrol
blufor_HELI_TRANS_UNARM_X =		"uns_uh34_USMC";   				//random patrol
...
blufor_PLANE_CAS_X =			"uns_F4B_CAS";					//dialog\request_hcCAS.sqf
blufor_PLANE_FIGHTER_X =		"uns_F4B_CAP";					//dialog\request_hcCAS1.sqf Dang
blufor_PLANE_PATROL_X = 		"uns_A1J_CAS";					//random patrol Dang
blufor_PLANE_PATROL1_X = 		"uns_A6_Intruder_USMC_CAS";		//random patrol Dang
blufor_PLANE_PATROL2_X = 		"uns_A4E_skyhawk_USMC_CAS";		//random patrol Dang
blufor_PLANE_PATROL3_X = 		"uns_A7_CAS";					//random patrol Dang
blufor_PLANE_CARGO_X = 			"uns_KC130_H";					//support\paradrop.sqf Dang
blufor_PLANE_RECON_X = 			"uns_ov10_usmc_CAS";			//support\uavmap.sqf Dang
...
blufor_STATIC_FLAG =			"uns_FlagCarrierUSMC";
...
blufor_SPECOPS_X =				"uns_men_US_3FRC_RF3";			//operator
blufor_SPECOPS_GL_X =			"uns_men_US_3FRC_GL";			//operator
blufor_SPECOPS_LAT_X =			"uns_men_US_3FRC_AT";			//operator
blufor_SPECOPS_HAT_X =			"uns_men_US_3FRC_AT";			//operator
blufor_SPECOPS_AA_X =			"uns_men_US_3FRC_RTO";			//operator
blufor_SPECOPS_MG_X =			"uns_men_US_3FRC_HMG";			//operator
blufor_SPECOPS_MEDIC_X =		"uns_men_US_3FRC_MED";			//operator
blufor_SPECOPS_MARK_X =			"uns_men_US_3FRC_MRK3";			//operator
blufor_SPECOPS_SNIPER_X =		"uns_men_US_3FRC_MRK";			//operator
blufor_SPECOPS_EXP_X =			"uns_men_US_3FRC_DEM";			//operator
blufor_SPECOPS_ENG_X = 			"uns_men_US_3FRC_ENG";			//operator
blufor_SPECOPS_SL_X = 			"uns_men_US_3FRC_SL";			//operator Dang
blufor_SPECOPS_PL_X = 			"uns_men_US_3FRC_PL";			//operator Dang
blufor_SPECOPS_ASS_X = 			"uns_men_US_3FRC_SCT";			//operator Dang
...
blufor_RQST_UNIT_01_X = 			["uns_men_USMC_68_RF2","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["uns_men_USMC_68_GL","Grenadier (3CP)",3];
blufor_RQST_UNIT_03_X =				["uns_men_USMC_68_HMG","Machinegunner (3CP)",3];
blufor_RQST_UNIT_04_X =				["uns_men_USMC_68_RTO","Radio Operator (2CP)",4];
blufor_RQST_UNIT_05_X =				["uns_men_USMC_68_MED","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["uns_men_USMC_68_AT","AT Rifleman (3CP)",3];
blufor_RQST_UNIT_07_X =				["uns_men_USMC_68_SL","Squad Leader (2CP)",4];
blufor_RQST_UNIT_08_X =				["uns_men_USMC_68_DEM","Demolitions Expert (3CP)",4];
blufor_RQST_UNIT_09_X =				["uns_men_USMC_68_ENG","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["uns_men_USMC_68_MRK2","Marksman (3CP)",3];
blufor_RQST_UNIT_11_X =				["uns_men_USMC_68_MRK","Sniper (4CP)",4];
...
blufor_RQST_VEHICLE_01_X =			["uns_willys_2_usmc","Willy's Jeep (1CP)",1];
blufor_RQST_VEHICLE_02_X =			["uns_willys_2_m60","Willy's Jeep M60 (2CP)",2];
blufor_RQST_VEHICLE_03_X =			["uns_willys_2_m1919","Willy's Jeep M1919 (3CP)",3];
...
blufor_RQST_VEHICLE_33_X =			["uns_UH1D_USMC_m60","UH-1D Iroquois Slick (25CP)",25];
blufor_RQST_VEHICLE_34_X =			["uns_ch34_USMC_M60","CH-34 Chocktaw (25CP)",25];
blufor_RQST_VEHICLE_35_X =			["uns_uh34_USMC","UH-34 Chocktaw Rockets (30CP)",30];
blufor_RQST_VEHICLE_36_X =			["uns_ch47_m60_usmc","CH-47 Chinook (30CP)",30];
...
blufor_RQST_VEHICLE_43_X =			["uns_A6_Intruder_USMC_CAS","A-6A Intruder (35CP)",35];
blufor_RQST_VEHICLE_44_X =			["uns_A4E_skyhawk_USMC_CAS","A-4E Skyhawk (40CP)",40];
...
blufor_RQST_VEHICLE_47_X =			["uns_F4E_CHICO","F-4E Phantom II Gunfighter (55CP)",55];
blufor_RQST_VEHICLE_48_X =			["uns_F4B_CAS","F-4B Phantom II CAS (55CP)",55];
blufor_RQST_VEHICLE_49_X =			["uns_F4B_CAP","F-4B Phantom II CAP (55CP)",55];
