...
blufor_SPECOPS_X =				"vn_b_men_sog_11";			//operator
blufor_SPECOPS_GL_X =			"vn_b_men_sog_07";			//operator
blufor_SPECOPS_LAT_X =			"vn_b_men_sog_14";			//operator
blufor_SPECOPS_HAT_X =			"vn_b_men_sog_02";			//operator
blufor_SPECOPS_AA_X =			"vn_b_men_sog_05";			//operator
blufor_SPECOPS_MG_X =			"vn_b_men_sog_16";			//operator
blufor_SPECOPS_MEDIC_X =		"vn_b_men_sog_03";			//operator
blufor_SPECOPS_MARK_X =			"vn_b_men_sog_12";			//operator
blufor_SPECOPS_SNIPER_X =		"vn_b_men_sog_21";			//operator
blufor_SPECOPS_EXP_X =			"vn_b_men_sog_08";			//operator
blufor_SPECOPS_ENG_X = 			"vn_b_men_army_04";			//operator
blufor_SPECOPS_SL_X = 			"vn_b_men_sog_13";			//operator Dang
blufor_SPECOPS_PL_X = 			"vn_b_men_sog_04";			//operator Dang
blufor_SPECOPS_ASS_X = 			"vn_b_men_sog_19";			//operator Dang
