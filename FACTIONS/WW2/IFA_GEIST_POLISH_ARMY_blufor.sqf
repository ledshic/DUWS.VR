...
///////////////
///////////////   GEIST1ArmiaWojskaPolskiego", "IFA GEIST POLISH ARMY", "IFA_GEIST_POLISH_ARMY
///////////////
...
blufor_SOLDIER_X =				"LIB_POL_Soldier_1AWPInfc7vbpSzM30";			//patrol, fortify
blufor_SOLDIER_LAT_X =			"LIB_SOV_AT_M1A1_soldier";						//initHQ\guards.sqf
blufor_SOLDIER_GL_X =			"LIB_POL_Soldier_1AWPInfc1vc7pStSzSvt40";		//initHQ\guards.sqf 
blufor_SOLDIER_TL_X =			"LIB_POL_Subofficer_1AWPInfbvbpCrzPpsch41m";	//initHQ\createpatrol.sqf
blufor_SOLDIER_SL_X =			"LIB_POL_Oficer_1AWPInfbvc1pPpckPpsch41m";		//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"LIB_POL_Mgunner_1AWPInfc7vc1pKplDp";			//initHQ\guards.sqf
blufor_MARKSMAN_X = 			"LIB_POL_Sniper_1AWPc7vbpSztM9130";				//initHQ\guards.sqf
blufor_OFFICER_X =				"LIB_POL_Oficer_1AWPInfc1vbpKpnPpsch41m";		//initHQ\BluHQinit.sqf
...
blufor_BOAT_CREW_X =			"LIB_POL_Soldier_1AWPInfc7vbpSzM30";				//support\taxi\boatTaxi.sqf
...
blufor_TURRET_FLAG =			"geist_Flag_POL02_F";				//LT.Dang Flag at HQ and FOBS

/////////////////////////
// PARADROP SUPPORT TROOPS Dang Edit
/////////////////////////

blufor_PARA_X =				"LIB_POL_Soldier_1AWPInfc7vbpSzM30";			//support\paradrop.sqf		
blufor_PARA_AT_X =			"LIB_SOV_AT_M1A1_soldier";						//support\paradrop.sqf	
blufor_PARA_GL_X =			"LIB_POL_Soldier_1AWPInfc1vc7pStSzSvt40";		//support\paradrop.sqf	
blufor_PARA_TL_X =			"LIB_POL_Subofficer_1AWPInfbvbpCrzPpsch41m";	//support\paradrop.sqf	
blufor_PARA_RAD_X =			"LIB_POL_Radioman_1AWPbvbpStSzM30";				//support\paradrop.sqf	
blufor_PARA_AR_X =			"LIB_POL_Mgunner_1AWPInfc7vc1pKplRKMwz28";		//support\paradrop.sqf	
blufor_PARA_MED_X =			"LIB_POL_Medic_1AWPc5vc1pSztSantBM30";			//support\paradrop.sqf
...
blufor_SPECOPS_X =				"LIB_POL_Soldier_1AWPInfc7vbpSzM30";			//operator
blufor_SPECOPS_GL_X =			"LIB_POL_Soldier_1AWPInfc1vc7pStSzSvt40";		//operator
blufor_SPECOPS_LAT_X =			"LIB_SOV_AT_M1A1_soldier";						//operator
blufor_SPECOPS_HAT_X =			"LIB_SOV_AT_soldier";							//operator
blufor_SPECOPS_AA_X =			"LIB_POL_Radioman_1AWPbvbpStSzM30";				//operator
blufor_SPECOPS_MG_X =			"LIB_POL_Mgunner_1AWPInfc7vc1pKplDp";			//operator
blufor_SPECOPS_AR_X =			"LIB_POL_Mgunner_1AWPInfc7vc1pKplRKMwz28";		//operator Dang Edit
blufor_SPECOPS_MEDIC_X =		"LIB_POL_Medic_1AWPc5vc1pSztSantBM30";			//operator
blufor_SPECOPS_MARK_X =			"LIB_POL_Sniper_1AWPc7vbpSztM9130";				//operator
blufor_SPECOPS_SNIPER_X =		"LIB_POL_Sniper_1AWPc7vbpSztM9130";				//operator
blufor_SPECOPS_EXP_X =			"LIB_POL_Sapper_1AWPInfc5vc7pSztPpsch41d";		//operator
blufor_SPECOPS_ENG_X = 			"LIB_POL_Sapper_1AWPInfc5vc7pSztPpsch41d";		//operator
blufor_SPECOPS_SL_X = 			"LIB_POL_Oficer_1AWPInfbvc1pPpckPpsch41m";		//operator Lt.Dang edit
blufor_SPECOPS_TL_X = 			"LIB_POL_Subofficer_1AWPInfbvbpCrzPpsch41m";	//operator Lt.Dang edit
blufor_SPECOPS_ASS_X = 			"LIB_POL_Subofficer_1AWPInfc5vc7pStSztPpsch41d";	//operator Lt.Dang edit
...
blufor_RQST_UNIT_01_X = 			["LIB_POL_Soldier_1AWPInfc7vbpSzM30","Rifleman Mosin Nagant (2CP)",2];
blufor_RQST_UNIT_02_X =				["LIB_SOV_grenadier","Grenadier (3CP)",3];
blufor_RQST_UNIT_03_X =				["LIB_POL_Soldier_1AWPInfc1vc7pStSzSvt40","Rifleman SVT 40 (3CP)",3];
blufor_RQST_UNIT_04_X =				["LIB_POL_Mgunner_1AWPInfc7vc1pKplDp","Machinegunner (4CP)",4];
blufor_RQST_UNIT_05_X =				["LIB_POL_Medic_1AWPc5vc1pSztSantBM30","Medic (4CP)",4];
...
blufor_RQST_UNIT_08_X =				["LIB_POL_Radioman_1AWPbvbpStSzM30","Radio Operator (4CP)",4];
blufor_RQST_UNIT_09_X =				["LIB_POL_Sapper_1AWPInfc5vc7pSztPpsch41d","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["LIB_POL_Sniper_1AWPc7vbpSztM9130","Sniper (3CP)",3];
