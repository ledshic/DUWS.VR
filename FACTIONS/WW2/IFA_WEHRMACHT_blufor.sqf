...
///////////////
///////////////   "LIB_WEHRMACHT", "IFA WEHRMACHT (Europe)","IFA_WEHRMACHT"
///////////////
...
blufor_SOLDIER_X =				"LIB_GER_scout_ober_rifleman";		//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"LIB_GER_AT_soldier";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_GL_X =			"LIB_GER_scout_ober_grenadier";		//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_TL_X =			"LIB_GER_stggunner";				//initHQ\createpatrol.sqf, initHQ\guards.sqf
blufor_SOLDIER_SL_X =			"LIB_GER_scout_lieutenant";			//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"LIB_GER_mgunner";					//support\paradrop.sqf, initHQ\guards.sqf
...
blufor_SPECOPS_X =				"SG_sturmtrooper_ober_rifleman";		//operator
blufor_SPECOPS_GL_X =			"SG_sturmtrooper_ober_grenadier";		//operator
blufor_SPECOPS_LAT_X =			"SG_sturmtrooper_LAT_rifleman";			//operator
blufor_SPECOPS_HAT_X =			"SG_sturmtrooper_AT_soldier";			//operator
blufor_SPECOPS_AA_X =			"SG_sturmtrooper_radioman";				//operator
blufor_SPECOPS_MG_X =			"SG_sturmtrooper_mgunner2";				//operator
blufor_SPECOPS_AR_X =			"SG_sturmtrooper_mgunner";				//operator Dang Edit
blufor_SPECOPS_MEDIC_X =		"SG_sturmtrooper_medic";				//operator
...
blufor_SPECOPS_SL_X = 			"SG_sturmtrooper_lieutenant";			//operator Lt.Dang edit
blufor_SPECOPS_TL_X = 			"SG_sturmtrooper_stggunner";			//operator Lt.Dang edit
blufor_SPECOPS_ASS_X = 			"SG_sturmtrooper_unterofficer";			//operator Lt.Dang edit
...
blufor_RQST_UNIT_01_X = 			["LIB_GER_scout_ober_rifleman","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["LIB_GER_scout_ober_grenadier","Grenadier  (3CP)",3];
blufor_RQST_UNIT_03_X =				["LIB_GER_scout_mgunner2","MG34 gunner (3CP)",3];
blufor_RQST_UNIT_04_X =				["LIB_GER_mgunner","MG42 gunner (4CP)",4];
blufor_RQST_UNIT_05_X =				["LIB_GER_medic","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["LIB_GER_AT_soldier","AT Soldier (4CP)",4];
blufor_RQST_UNIT_07_X =				["LIB_GER_radioman","Radioman (2CP)",2];
