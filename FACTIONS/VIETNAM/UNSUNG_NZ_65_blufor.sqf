///////////////
///////////////   "UNSUNG_NZ", "Royal New Zealand Infantry Regiment 2RARNZ\SAS 1965","UNSUNG_NZ_65"
///////////////
...
blufor_SOLDIER_X =				"uns_men_NZ_65_RF1";					//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"uns_men_NZ_65_AT";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_GL_X =			"uns_men_NZ_65_GL";				//initHQ\guards.sqf, support\paradrop.sqf
blufor_SOLDIER_TL_X =			"uns_men_NZ_65_SL";				//initHQ\createpatrol.sqf, initHQ\guards.sqf
blufor_SOLDIER_SL_X =			"uns_men_NZ_65_PL";				//support\cluster\cluster.sqf (comms voice), Multiplayer slot
blufor_SOLDIER_AR_X =			"uns_men_NZ_65_HMG";				//support\paradrop.sqf, initHQ\guards.sqf
blufor_MARKSMAN_X = 			"uns_men_NZ_65_MRK";				//initHQ\guards.sqf
blufor_OFFICER_X =				"uns_men_NZ_65_COM";				//initHQ\BluHQinit.sqf
blufor_HELI_PILOT_X	=			"uns_pil_nz";					//missions\missions\pilot\mission.sqf

blufor_BOAT_ARMED_X	=			"uns_pbr_mk18";					//support\taxi\boatTaxi.sqf
blufor_BOAT_CREW_X =			"uns_bw2";						//support\taxi\boatTaxi.sqf

blufor_HELI_TRANS_ARM_X =		"uns_UH1D_raaf_m60";					//support\taxi\helotaxi.sqf, random patrol
blufor_HELI_TRANS_UNARM_X =		"uns_UH1D_raaf_m60";   			//random patrol
...
blufor_PLANE_CAS_X =			"UNS_F111_D_CAS";				//dialog\request_hcCAS.sqf
blufor_PLANE_FIGHTER_X =		"UNS_F111_D_CAP";				//dialog\request_hcCAS1.sqf Dang
blufor_PLANE_PATROL_X = 		"uns_A4E_skyhawk_RAN_CAS";		//random patrol Dang
blufor_PLANE_PATROL1_X = 		"UNS_F111_D_CBU";				//random patrol Dang
blufor_PLANE_PATROL2_X = 		"uns_A4E_skyhawk_RAN_SEAD";		//random patrol Dang
blufor_PLANE_PATROL3_X = 		"uns_A4E_skyhawk_RAN_MR";		//random patrol Dang
...
blufor_STATIC_FLAG =			"uns_FlagCarrierNZ";
...
blufor_SPECOPS_X =				"uns_men_sas_RF1";			//operator
blufor_SPECOPS_GL_X =			"uns_men_sas_GL";			//operator
blufor_SPECOPS_LAT_X =			"uns_men_sas_GL2";			//operator
blufor_SPECOPS_HAT_X =			"uns_men_sas_RF2";			//operator
blufor_SPECOPS_AA_X =			"uns_men_sas_RTO";			//operator
blufor_SPECOPS_MG_X =			"uns_men_sas_MG";			//operator
blufor_SPECOPS_MEDIC_X =		"uns_men_NZ_65_MED";		//operator
blufor_SPECOPS_MARK_X =			"uns_men_sas_MRK";			//operator
blufor_SPECOPS_SNIPER_X =		"uns_men_sas_MRK";			//operator
blufor_SPECOPS_EXP_X =			"uns_men_sas_SCT";			//operator
blufor_SPECOPS_ENG_X = 			"uns_men_sas_RF2";			//operator
blufor_SPECOPS_SL_X = 			"uns_men_sas_NCO";			//operator Dang
blufor_SPECOPS_PL_X = 			"uns_men_sas_PL";			//operator Dang
blufor_SPECOPS_ASS_X = 			"uns_men_sas_SCT";			//operator Dang
...
blufor_RQST_UNIT_01_X = 			["uns_men_NZ_65_RF2","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["uns_men_NZ_65_GL","Grenadier (3CP)",3];
blufor_RQST_UNIT_03_X =				["uns_men_NZ_65_HMG","Machinegunner (3CP)",3];
blufor_RQST_UNIT_04_X =				["uns_men_NZ_65_RTO","Radio Operator (2CP)",4];
blufor_RQST_UNIT_05_X =				["uns_men_NZ_65_MED","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["uns_men_NZ_65_AT","AT Rifleman (3CP)",3];
blufor_RQST_UNIT_07_X =				["uns_men_NZ_65_SL","Squad Leader (2CP)",4];
blufor_RQST_UNIT_08_X =				["uns_men_NZ_65_DEM","Demolitions Expert (3CP)",4];
blufor_RQST_UNIT_09_X =				["uns_men_NZ_65_ENG","Engineer (4CP)",4];
blufor_RQST_UNIT_10_X =				["uns_men_NZ_65_MRK","Sniper (3CP)",3];
...
blufor_RQST_VEHICLE_33_X =			["uns_UH1D_raaf_m60","UH-1D Iroquois Slick (25CP)",25];
blufor_RQST_VEHICLE_34_X =			["uns_ch34_army_M60","CH-34 Chocktaw (28CP)",28];
blufor_RQST_VEHICLE_35_X =			["uns_ch47_m60_1AC","CH-47 Chinook (30CP)",30];
blufor_RQST_VEHICLE_36_X =			["uns_UH1C_M6_M200","UH-1C Huey Gunship M60(30CP)",30];
blufor_RQST_VEHICLE_37_X =			["uns_UH1C_M21_M200_1AC","UH-1C Huey Gunship M134 (35CP)",35];
blufor_RQST_VEHICLE_38_X =			["uns_UH1C_M6_M200_M134","UH-1C Huey Gunship M134 Gunners (35CP)",35];
blufor_RQST_VEHICLE_39_X =			["uns_ach47_m200","CH-47 Chinook Guns a GoGo (40CP)",40];
blufor_RQST_VEHICLE_40_X =			["UNS_AH1G_FFAR","AH-1G Cobra (45CP)",45];
blufor_RQST_VEHICLE_41_X =			["uns_A4E_skyhawk_RAN_SEAD","A-4E Skyhawk (CAP) (30CP)",30];
blufor_RQST_VEHICLE_42_X =			["uns_A4E_skyhawk_RAN_CAS","A-4E Skyhawk (CAS) (30CP)",30];
blufor_RQST_VEHICLE_43_X =			["uns_A4E_skyhawk_RAN_MR","A-4E Skyhawk (MR) (30CP)",30];
blufor_RQST_VEHICLE_44_X =			["UNS_F111_D_CAP","F-111D Aardvark (CAP) (40CP)",45];
blufor_RQST_VEHICLE_45_X =			["UNS_F111_D_CAS","F-111D Aardvark (CAS) (45CP)",45];
blufor_RQST_VEHICLE_46_X =			["UNS_F111_D_CBU","F-111D Aardvark (CBU) (45CP)",45];
