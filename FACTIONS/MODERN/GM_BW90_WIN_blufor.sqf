...
blufor_SOLDIER_X =				"gm_ge_army_rifleman_g36a1_90_win";				//patrol, fortify, paradrop
blufor_SOLDIER_LAT_X =			"gm_ge_army_antitank_g36a1_pzf3_90_win";		//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_GL_X =			"gm_ge_army_grenadier_hk69a1_90_win";			//initHQ\fnc_HQguards, supports\fnc_paradrop
blufor_SOLDIER_TL_X =			"gm_ge_army_squadleader_g36a1_p2a1_90_win";		//initHQ\fnc_createpatrolFOB, initHQ\fnc_HQguards
blufor_SOLDIER_SL_X =			"gm_ge_army_radioman_g36a1_90_win";				//Comms voice, Multiplayer slot
blufor_SOLDIER_AR_X =			"gm_ge_army_machinegunner_mg3_90_win";			//supports\fnc_paradrop, initHQ\fnc_HQguards
blufor_MARKSMAN_X = 			"gm_ge_army_marksman_g3a3_90_win";				//initHQ\fnc_HQguards
blufor_OFFICER_X =				"gm_ge_army_officer_p1_90_win";					//initHQ\fnc_BluHQinit
...
blufor_BOAT_CREW_X =			"gm_ge_army_rifleman_g36a1_90_win";				//supports\taxi\fnc_boatTaxi

blufor_HELI_TRANS_ARM_X =		"UK3CB_CW_US_B_LATE_UH60M";						//supports\taxi\fnc_helotaxi, random patrol
blufor_HELI_TRANS_UNARM_X =		"gm_ge_army_ch53g_un";   						//random patrol
...
blufor_CAR_PATROL1_X =			"gm_ge_army_fuchsa0_engineer_win";						//random patrol
blufor_APC_PATROL1_X =			"gm_ge_army_luchsa2_win";						//random patrol
blufor_APC_PATROL2_X =			"gm_ge_army_marder1a2_win";						//random patrol
blufor_TANK_PATROL1_X =			"gm_ge_army_Leopard1a5_win";					//random patrol
...
blufor_SPECOPS_X =				"gm_ge_army_rifleman_g36a1_90_win";					//operator
blufor_SPECOPS_GL_X =			"gm_ge_army_grenadier_hk69a1_90_win";				//operator
blufor_SPECOPS_LAT_X =			"gm_ge_army_antitank_g36a1_pzf3_90_win";			//operator
blufor_SPECOPS_HAT_X =			"gm_ge_army_antitank_g36a1_pzf3_90_win";			//operator
blufor_SPECOPS_AA_X =			"gm_ge_army_antiair_g36a1_fim43_90_win";			//operator
blufor_SPECOPS_MG_X =			"gm_ge_army_machinegunner_mg3_90_win";				//operator
blufor_SPECOPS_MEDIC_X =		"gm_ge_army_medic_g36a1_90_win";					//operator
blufor_SPECOPS_MARK_X =			"gm_ge_army_marksman_g3a3_90_win";					//operator
blufor_SPECOPS_SNIPER_X =		"gm_ge_army_marksman_g3a3_90_win";					//operator
blufor_SPECOPS_EXP_X =			"gm_ge_army_demolition_g36a1_90_win";				//operator
blufor_SPECOPS_ENG_X = 			"gm_ge_army_engineer_g36a1_90_win";					//operator
...
blufor_RQST_UNIT_01_X = 			["gm_ge_army_rifleman_g36a1_90_win","Rifleman (2CP)",2];
blufor_RQST_UNIT_02_X =				["gm_ge_army_grenadier_hk69a1_90_win","Grenadier (GraPi) (3CP)",3];
blufor_RQST_UNIT_03_X =				["gm_ge_army_machinegunner_mg3_90_win","Machinegunner (MG3) (3CP)",3];
blufor_RQST_UNIT_04_X =				["gm_ge_army_demolition_g36a1_90_win","Explosive Specialist (4CP)",4];
blufor_RQST_UNIT_05_X =				["gm_ge_army_medic_g36a1_90_win","Medic (4CP)",4];
blufor_RQST_UNIT_06_X =				["gm_ge_army_antitank_g36a1_pzf3_90_win","AT Specialist (4CP)",4];
blufor_RQST_UNIT_07_X =				["gm_ge_army_antiair_g36a1_fim43_90_win","AA Specialist (4CP)",4];
blufor_RQST_UNIT_08_X =				["gm_ge_army_engineer_g36a1_90_win","Engineer (4CP)",4];
blufor_RQST_UNIT_09_X =				["gm_ge_army_marksman_g3a3_90_win","Marksman (3CP)",3];
blufor_RQST_UNIT_10_X =				["gm_ge_army_crew_90_flk","Crewman (2CP)",4];
blufor_RQST_UNIT_11_X =				["gm_ge_army_antitank_g36a1_milan_90_win","Rifleman (Milan) (4CP)",4];
...
blufor_RQST_VEHICLE_15_X =			["gm_ge_army_marder1a2_win","Marder 1A2 (30CP)",30];
blufor_RQST_VEHICLE_16_X =			["gm_ge_army_luchsa2_win","Luchs 2A1 (25CP)",25];
blufor_RQST_VEHICLE_17_X =			["gm_ge_army_Leopard1a5_win","Leopard 1A5 (35CP)",35];
